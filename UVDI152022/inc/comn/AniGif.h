...
public:
	...
	BOOL Load(LPCTSTR szFileName, BOOL ready /* TRUE : Ready, FALSE : Wait */);
	...
	BOOL IsLoaded()	{	return m_bIsInitialized;	}
...
protected:
	...
	BOOL m_bReady;	/* TRUE : Ready, FALSE : Wait */
	HDC m_hMemDC;
