...
class CMyFolder : public CCommonDialog
{
	DECLARE_DYNAMIC( CMyFolder )

public:
	CMyFolder(	IN LPCTSTR	pszTitle	= NULL, 
					IN LPCTSTR	pszSelPath	= NULL,
					IN CWnd*	pWndParent	= NULL,
					IN UINT		uFlags		= BIF_RETURNONLYFSDIRS );
	virtual ~CMyFolder( VOID );
...
public:
	...
	LPTSTR	SetSelectedFolder( IN LPCTSTR pszPath );
...
AFX_INLINE LPCTSTR CMyFolder::GetSelectedFolder( VOID ) const
	{ return m_szSelPath; }

AFX_INLINE BROWSEINFO& CMyFolder::GetBI( VOID )
	{ return m_bi; }

AFX_INLINE const BROWSEINFO& CMyFolder::GetBI( VOID ) const
	{ return m_bi; }

/////////////////////////////////////////////////////////////////////////////
// Filled after a call to DoModal

AFX_INLINE LPCTSTR CMyFolder::GetFolderPath( VOID ) const
	{ return m_szFolPath; }

AFX_INLINE LPCTSTR CMyFolder::GetFolderName( VOID ) const
	{ return m_bi.pszDisplayName; }

AFX_INLINE INT CMyFolder::GetFolderImage( VOID ) const
	{ return m_bi.iImage; }
