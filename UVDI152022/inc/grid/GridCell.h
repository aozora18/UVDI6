...
public:
	...
	virtual void  SetDesText(LPCTSTR szText)	 { m_strDes = szText; }
	virtual void  SetTranslation(BOOL bState)    { m_bTranslation = bState; }
	...
	virtual LPCTSTR     GetDesText() const          { return (m_strDes.IsEmpty()) ? _T("") : LPCTSTR(m_strDes); }
	virtual BOOL        GetTranslation() const      { return m_bTranslation; }	// 20221011 mhbaek Add
...
protected:
	...
	CString    m_strDes;      // 20160803 by yoon 설명 추가
	BOOL       m_bTranslation;
