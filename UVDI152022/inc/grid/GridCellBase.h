...
public:
	...
	virtual void SetDesText(LPCTSTR /* szText */)           = 0 ;	// 20160803 by yoon
	virtual void SetTranslation(BOOL /* szText */)          = 0 ;	// 20221011 mhbaek Add
	...
	virtual LPCTSTR    GetDesText()    const                = 0;	// 20160803 by yoon
	virtual BOOL       GetTranslation()const                = 0;	// 20221011 mhbaek Add
