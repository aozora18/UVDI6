...
#define GVN_COLUMNCLICK         LVN_COLUMNCLICK     // 230612 기준 미사용
...
///// LUC ///////////////////////////////////////////////////////////////////////
	...
	void ReleaseMergeCells(); //20210209 JBP
	...
	BOOL GetMergedCellRange(int row, int col, CCellRange& mergedCellRange);
...
public:
	...
	void SetScrollCell(int nRow, int nCol, int nMoveToRow, int nMoveToCol);
	void SetCellView(int nRow, int nCol);
...
public:
	...
	BOOL   SetItemTextDes(int nRow, int nCol, LPCTSTR str);	// 20160803 by yoon
	void   SetItemTextTranslation(int nRow, int nCol, BOOL bUse);	// 20221011 mhbaek Add
    ...
    BOOL    SetItemUILevel(int nRow, int nCol, UINT level);
