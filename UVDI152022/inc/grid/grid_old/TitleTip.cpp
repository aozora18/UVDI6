...
CTitleTip::CTitleTip()
{
    ...
    m_u64LastLButtonDown= UINT64_MAX;
    m_u64DblClickMsecs  = GetDoubleClickTime();
    m_bCreated          = FALSE;
    m_pParentWnd        = NULL;
}
...
BOOL CTitleTip::PreTranslateMessage(MSG* pMsg) 
{
	...
	case WM_LBUTTONDOWN:
       // Get tick count since last LButtonDown
        ...
        bDoubleClick = ((u64Tick - m_u64LastLButtonDown) <= m_u64DblClickMsecs);
        m_u64LastLButtonDown = u64Tick;
