...
/*
 ...
 retn : TRUE or FALSE
*/
API_IMPORT BOOL uvTrig_Init(LPG_CIEA config, LPG_TPQR shmem, LPG_DLSM link);
/*
 desc : PLC Server와 통신을 담당하는 Client 스레드 생성 및 실행
 parm : config	- [in]  환경 설정 정보
		shmem	- [in]  Trigger Service 관련 공유 메모리
 retn : TRUE or FALSE
*/
API_IMPORT BOOL uvTrig_Open(LPG_CIEA config, LPG_TPQR shmem);
/*
 desc : 라이브러리 해제
 parm : None
 retn : None
*/
API_IMPORT VOID uvTrig_Close();
/*
 desc : 시스템 재접속 수행
 parm : None
 retn : TRUE or FALSE
*/
API_IMPORT BOOL uvTrig_Reconnected();
/*
 desc : 현재 PLC가 연결되어 있는지 여부 확인
 parm : None
 retn : TRUE or FALSE
*/
API_IMPORT BOOL uvTrig_IsConnected();
/*
 desc : 초기 연결되고 난 이후 수신된 데이터가 존재하는지 여부
 parm : None
 retn : TRUE or FALSE
*/
API_IMPORT BOOL uvTrig_IsInitRecv();
#if 1
/*
 ...
 retn : TRUE or FALSE
*/
API_IMPORT BOOL uvTrig_ReqInitUpdate();
#endif
/*
 ...
 retn : TRUE or FALSE
*/
API_IMPORT BOOL uvTrig_ResetTrigPosAll();
/*
 ...
 retn : TRUE or FALSE
*/
API_IMPORT BOOL uvTrig_IsTrigPosReset(UINT8 cam_id, UINT8 count=MAX_REGIST_TRIG_POS_COUNT);
/*
 ...
 retn : TRUE or FALSE
*/
API_IMPORT BOOL uvTrig_ReqWriteAreaTrigPos(BOOL direct,
...
/*
 ...
 retn : TRUE or FALSE
*/
API_IMPORT BOOL uvTrig_ReqWriteAreaTrigPosCh(UINT8 cam_id, UINT8 start, UINT8 count, PUINT32 pos,
											 ENG_TEED enable, BOOL clear);
/*
 ...
 retn : TRUE or FALSE
*/
API_IMPORT BOOL uvTrig_ReqTriggerStrobe(BOOL enable);
/*
 desc : IP 변경하기
 parm : ip_addr	- [in]  패킷 정보가 저장된 구조체 포인터
 retn : TRUE or FALSE
*/
API_IMPORT BOOL uvTrig_ReqIP4Addr(PUINT8 ip_addr);
/*
 desc : EEPROM Write
 parm : mode	- [in]  0x01 - Read, 0x02 - Write
 retn : TRUE or FALSE
*/
API_IMPORT BOOL uvTrig_ReqEEPROMCtrl(UINT8 mode);
/*
 desc : Board S/W Reset
 parm : None
 retn : TRUE or FALSE
*/
API_IMPORT BOOL uvTrig_ReqBoardReset();
/*
 desc : 내부 트리거 설정
 parm : cam_id	- [in]  Align Camera Index (1 or 2)
 retn : TRUE or FALSE
*/
API_IMPORT BOOL uvTrig_ReqEncoderLive(UINT8 cam_id);
/*
 desc : 내부 트리거 설정 초기화
 parm : None
 retn : TRUE or FALSE
*/
API_IMPORT BOOL uvTrig_ReqEncoderOutReset();
/*
 desc : 트리거 1개 발생 시킴 (Only Trigger Event)
 parm : cam_id	- [in]  Align Camera Index (1 or 2)
 retn : TRUE or FALSE
*/
API_IMPORT BOOL uvTrig_ReqTrigOutOneOnly(UINT8 cam_id);
/*
 ...
 retn : TRUE or FALSE
*/
API_IMPORT BOOL uvTrig_ReqTrigOutOne(UINT8 cam_id, BOOL enable=TRUE);
/*
 ...
 retn : TRUE or FALSE
*/
API_IMPORT BOOL uvTrig_IsTrigPosEqual(UINT8 ch_no, UINT8 index, UINT32 pos);
/*
...
*/
API_IMPORT BOOL uvTrig_IsSendCmdCountUnder(UINT16 count);
