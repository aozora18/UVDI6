...
/*
 desc : Return all robot information
 parm : None
 retn : Structure pointer where all robot information is stored
*/
LPG_MRDV GetShMemMDR()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return NULL;
...
/* --------------------------------------------------------------------------------------------- */
/*                 External Interface - Diamond Robot for Logosol < for Engine >                 */
/* --------------------------------------------------------------------------------------------- */
...
/*
 ...
 retn : TRUE or FALSE
*/
API_EXPORT BOOL uvEng_MDR_IsConnected()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_IsConnected();
}
...
/*
 ...
 retn : None
*/
API_EXPORT VOID uvEng_MDR_ResetCommData()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return;
	uvMDR_ResetCommData();
}
...
*/
API_EXPORT ENG_MSAS uvEng_MDR_GetLastSendAckStatus()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return ENG_MSAS::none;
	return uvMDR_GetLastSendAckStatus();
}
...
/*
 ...
 exam : 
*/
API_EXPORT BOOL uvEng_MDR_SetDateTime()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetDateTime();
}
API_EXPORT BOOL uvEng_MDR_GetDateTime()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetDateTime();
}
...
/*
 ...
 exam : 
*/
API_EXPORT BOOL uvEng_MDR_SetSystemConfigInfo()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetSystemConfigInfo();
}
API_EXPORT BOOL uvEng_MDR_GetSystemConfigInfo()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetSystemConfigInfo();
}
...
/*
 ...
 exam : 
*/
API_EXPORT BOOL uvEng_MDR_ResetMotionController()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_ResetMotionController();
}
...
/*
 ...
 exam : 
*/
API_EXPORT BOOL uvEng_MDR_GetRobotSerialNumber()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetRobotSerialNumber();
}
...
/*
 ...
 exam : 
*/
API_EXPORT BOOL uvEng_MDR_GetRobotFirmwareVer(UINT8 option)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetRobotFirmwareVer(option);
}
...
/*
 ...
 exam : >_CLD
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_RestoreCustomParameter()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_RestoreCustomParameter();
}
...
/*
 ...
 exam : >_CPA 0 123
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SaveCustomParameter()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SaveCustomParameter();
}
...
/*
 ...
 exam : None
*/
API_EXPORT BOOL uvEng_MDR_RestoreMotionCalibrationParam()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_RestoreMotionCalibrationParam();
}
...
/*
 ...
 exam : None
*/
API_EXPORT BOOL uvEng_MDR_ReadParametersSetsFromDisk()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_ReadParametersSetsFromDisk();
}

/*
 desc : Restore Station Parameters (cmd : rsp)
 parm : None
 retn : TRUE or FALSE
 note : This command restores all the station parameters previously saved by SSP command
 exam : None
*/
API_EXPORT BOOL uvEng_MDR_RestoreStationParameters()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_RestoreStationParameters();
}

/*
 desc : Save Parameters Sets to Disk (cmd : sps)
 parm : None
 retn : TRUE or FALSE
 note : This command saves all parameter sets to disk file named paramset.ini,
		overwriting any existing file.
		This command should be executed if any changes made to parameter sets are to be preserved.
		This command cannot be used if the robot is busy (e.g. motion is active).
 exam : None
*/
API_EXPORT BOOL uvEng_MDR_SaveParametersSetsToDisk()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SaveParametersSetsToDisk();
}
...
/*
 ...
 exam : >SSP
		>
*/
API_EXPORT BOOL uvEng_MDR_SaveStationParameters()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SaveStationParameters();
}
...
/*
 ...
 exam : >__CS
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_GetCurrentRobotState()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetCurrentRobotState();
}
...
/*
 ...
 exam : >CPO R
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_GetAxisCurrentPositionAll()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetAxisCurrentPositionAll();
}
...
/*
 ...
 exam : >INF 0
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetInfoMode()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetInfoMode(0x01);
}
API_EXPORT BOOL uvEng_MDR_GetInfoMode()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetInfoMode();
}
...
/*
 ...
 exam : >PUT A 1
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_GetDiagInfoCurrent()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetDiagInfoCurrent();
}
API_EXPORT BOOL uvEng_MDR_GetDiagInfoLast()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetDiagInfoLast();
}
...
/*
 ...
 exam : >INF 5
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_GetExtendedErrorNumber()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetExtendedErrorNumber();
}
...
/*
 ...
 exam : >PUT A 1
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_GetExtendedErrorState()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetExtendedErrorState();
}
...
/*
 ...
 exam : >ESTA
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_GetExtendedErrorStateCode()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetExtendedErrorStateCode();
}
...
*/
API_EXPORT BOOL uvEng_MDR_GetPreviousErrorReason()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetPreviousErrorReason();
}
...
*/
API_EXPORT BOOL uvEng_MDR_GetHomeSwitchAll()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetHomeSwitchAll();
}
...
/*
 ...
 exam : None
*/
API_EXPORT BOOL uvEng_MDR_SaveMotionCalibrationParam(UINT8 option)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SaveMotionCalibrationParam(option);
}
...
*/
API_EXPORT BOOL uvEng_MDR_GetSystemStatus()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetSystemStatus();
}
...
/*
 ...
 exam : None
*/
API_EXPORT BOOL uvEng_MDR_SetAxisEncoderReset(ENG_RANC axis, ENG_RAEC mode, PCHAR password)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetAxisEncoderReset(axis, mode, password);
}
...
/*
 ...
 exam : >_AEST
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_GetEconderStatus()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetEconderStatus();
}
...
/*
 ...
 exam : >_EO
		...
		-15
*/
API_EXPORT BOOL uvEng_MDR_SetEncoderZeroOffsetValue(ENG_RANC axis, DOUBLE value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetEncoderZeroOffsetValue(axis, value);
}
API_EXPORT BOOL uvEng_MDR_GetEncoderZeroOffset()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetEncoderZeroOffset();
}
...
/*
 ...
 exam : >_EOR
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetEncoderZeroOffsetAll()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetEncoderZeroOffsetAll();
}
API_EXPORT BOOL uvEng_MDR_GetEncoderZeroOffsetAll()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetEncoderZeroOffsetAll();
}
...
/*
 ...
 exam : >_RALMZ Z
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_GetLowLevelEncoderStatus(ENG_RANC axis)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetLowLevelEncoderStatus(axis);
}
...
*/
API_EXPORT BOOL uvEng_MDR_SetBackupPowerCtrl(UINT8 option, INT32 value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetBackupPowerCtrl(option, value);
}
API_EXPORT BOOL uvEng_MDR_GetBackupPowerCtrl()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetBackupPowerCtrl();
}
...
/*
 ...
 exam : >CSTP
		...
		10
*/
API_EXPORT BOOL uvEng_MDR_SetControlledStopFeature(UINT8 state, UINT8 option)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetControlledStopFeature(state, option);
}
API_EXPORT BOOL uvEng_MDR_GetControlledStopFeature()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetControlledStopFeature();
}
...
/*
 ...
 exam : None
*/
API_EXPORT BOOL uvEng_MDR_GetStateExtDI()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetStateExtDI();
}
...
/*
 ...
 exam : None
*/
API_EXPORT BOOL uvEng_MDR_SetStateExtDONo(UINT8 output, UINT8 value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetStateExtDONo(output, value);
}
API_EXPORT BOOL uvEng_MDR_GetStateExtDO()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetStateExtDO();
}
...
/*
 ...
 exam : >INP 1
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetStateInput(UINT8 input)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetStateInput(input);
}
API_EXPORT BOOL uvEng_MDR_GetStateInput()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetStateInput();
}
...
/*
 ...
 exam : None
*/
API_EXPORT BOOL uvEng_MDR_SetLoadedSpeedParamEnable(UINT8 option)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetLoadedSpeedParamEnable(option);
}
API_EXPORT BOOL uvEng_MDR_GetLoadedSpeedParamEnable()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetLoadedSpeedParamEnable();
}
...
/*
 ...
 exam : >OUT
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetStateOutput(UINT8 output, UINT8 value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetStateOutput(output, value);
}
API_EXPORT BOOL uvEng_MDR_GetStateOutput()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetStateOutput();
}
...
/*
 ...
 exam : >STA
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetAxisServoTurnOff(ENG_RANC axis)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetAxisServoTurnOff(axis);
}
API_EXPORT BOOL uvEng_MDR_SetAxisServoTurnOn(ENG_RANC axis)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetAxisServoTurnOn(axis);
}
...
/*
 ...
 exam : >STA
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetVacuumPaddleTurnOff(UINT8 effect_num)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetVacuumPaddleTurnOff(effect_num);
}
API_EXPORT BOOL uvEng_MDR_SetVacuumPaddleTurnOn(UINT8 effect_num)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetVacuumPaddleTurnOn(effect_num);
}
...
/*
 ...
 exam : >STA
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_GetCheckWaferInVacuumPaddle(UINT8 number)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetCheckWaferInVacuumPaddle(number);
}
...
/*
 ...
 exam : >_CH
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetCustomizedHomePosition(ENG_RANC axis, DOUBLE value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetCustomizedHomePosition(axis, value);
}
API_EXPORT BOOL uvEng_MDR_GetCustomizedHomePosition()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetCustomizedHomePosition();
}
...
/*
 ...
 exam : >_CL
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetAxisCurrentLimitLevel(ENG_RANC axis, UINT8 value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetAxisCurrentLimitLevel(axis, value);
}
API_EXPORT BOOL uvEng_MDR_GetAxisCurrentLimitLevel()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetAxisCurrentLimitLevel();
}
...
/*
 ...
 exam : >_EL
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetAxisPositionErrorLimit(ENG_RANC axis, INT32 value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetAxisPositionErrorLimit(axis, value);
}
API_EXPORT BOOL uvEng_MDR_GetAxisPositionErrorLimit()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetAxisPositionErrorLimit();
}
...
/*
 ...
 exam : >_FSE
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetAxisSafeEnvelop(ENG_RANC axis, ENG_MAMD direct, INT32 value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetAxisSafeEnvelop(axis, direct, value);
}
API_EXPORT BOOL uvEng_MDR_GetAxisSafeEnvelop(ENG_MAMD direct)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetAxisSafeEnvelop(direct);
}
...
/*
 ...
 exam : >_FL
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetAxisSoftwareLimitValue(ENG_RANC axis, ENG_MAMD direct, INT32 value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetAxisSoftwareLimitValue(axis, direct, value);
}
API_EXPORT BOOL uvEng_MDR_SetAxisSoftwareLimitCurrent(ENG_RANC axis, ENG_MAMD direct)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetAxisSoftwareLimitCurrent(axis, direct);
}
API_EXPORT BOOL uvEng_MDR_GetAxisSoftwareLimit(ENG_MAMD direct)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetAxisSoftwareLimit(direct);
}
...
/*
 ...
 exam : None
*/
API_EXPORT BOOL uvEng_MDR_SetDiffCoeffAxisHold(ENG_RANC axis, UINT32 value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetDiffCoeffAxisHold(axis, value);
}
API_EXPORT BOOL uvEng_MDR_GetDiffCoeffAxisHold()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetDiffCoeffAxisHold();
}
...
/*
 ...
 exam : None
*/
API_EXPORT BOOL uvEng_MDR_SetPosErrorLimitAxisHold(ENG_RANC axis, DOUBLE value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetPosErrorLimitAxisHold(axis, value);
}
API_EXPORT BOOL uvEng_MDR_GetPosErrorLimitAxisHold()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetPosErrorLimitAxisHold();
}
...
/*
 ...
 exam : None
*/
API_EXPORT BOOL uvEng_MDR_SetPropCoeffAxisHold(ENG_RANC axis, UINT32 value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetPropCoeffAxisHold(axis, value);
}
API_EXPORT BOOL uvEng_MDR_GetPropCoeffAxisHold()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetPropCoeffAxisHold();
}
...
/*
 ...
 exam : >_HO
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetAxisHomeOffsetValue(ENG_RANC axis, DOUBLE value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetAxisHomeOffsetValue(axis, value);
}
API_EXPORT BOOL uvEng_MDR_GetAxisHomeOffset()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetAxisHomeOffset();
}
...
/*
 ...
 exam : >_IL
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetIntegralLimit(ENG_RANC axis, DOUBLE value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetIntegralLimit(axis, value);
}
API_EXPORT BOOL uvEng_MDR_GetIntegralLimit()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetIntegralLimit();
}
...
/*
 ...
 exam : >_KD
		...
		1200,1800,2000
*/
API_EXPORT BOOL uvEng_MDR_SetDiffCoeffAxis(ENG_RANC axis, UINT32 value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetDiffCoeffAxis(axis, value);
}
API_EXPORT BOOL uvEng_MDR_GetDiffCoeffAxis()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetDiffCoeffAxis();
}
...
/*
 ...
 exam : >_KI
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetInteCoeffAxis(ENG_RANC axis, UINT32 value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetInteCoeffAxis(axis, value);
}
API_EXPORT BOOL uvEng_MDR_GetInteCoeffAxis()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetInteCoeffAxis();
}
...
/*
 ...
 exam : >_KP
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetPropCoeffAxis(ENG_RANC axis, UINT32 value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetPropCoeffAxis(axis, value);
}
API_EXPORT BOOL uvEng_MDR_GetPropCoeffAxis()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetPropCoeffAxis();
}
...
/*
 ...
 exam : 
*/
API_EXPORT BOOL uvEng_MDR_SetAxisAcceleration(ENG_RANC axis, ENG_MAST type, DOUBLE value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetAxisAcceleration(axis, type, value);
}
API_EXPORT BOOL uvEng_MDR_GetAxisAcceleration(ENG_MAST type)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetAxisAcceleration(type);
}
...
/*
 ...
 exam : >AJK T 600
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetAxisAccelerationJerk(ENG_RANC axis, ENG_MAST type, UINT16 value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetAxisAccelerationJerk(axis, type, value);
}
API_EXPORT BOOL uvEng_MDR_GetAxisAccelerationJerk(ENG_MAST type)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetAxisAccelerationJerk(type);
}
...
/*
 ...
 exam : >ACL
		...
		1000
*/
API_EXPORT BOOL uvEng_MDR_SetAxisLoadedAcceleration(ENG_RANC axis, ENG_MAST type, DOUBLE value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetAxisLoadedAcceleration(axis, type, value);
}
API_EXPORT BOOL uvEng_MDR_GetAxisLoadedAcceleration(ENG_MAST type)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetAxisLoadedAcceleration(type);
}
...
/*
 ...
 exam : None
*/
API_EXPORT BOOL uvEng_MDR_SetAxisLoadedAccelerationJerk(ENG_RANC axis, ENG_MAST type, UINT16 value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetAxisLoadedAccelerationJerk(axis, type, value);
}
API_EXPORT BOOL uvEng_MDR_GetAxisLoadedAccelerationJerk(ENG_MAST type)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetAxisLoadedAccelerationJerk(type);
}
...
/*
 ...
 exam : >SPD
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetAxisLoadedSpeed(ENG_RANC axis, DOUBLE value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetAxisLoadedSpeed(axis, value);
}
API_EXPORT BOOL uvEng_MDR_GetAxisLoadedSpeed()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetAxisLoadedSpeed();
}
...
/*
 ...
 exam : >SPD T 2000
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetAxisWorkingSpeed(ENG_RANC axis, DOUBLE value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetAxisWorkingSpeed(axis, value);
}
API_EXPORT BOOL uvEng_MDR_GetAxisWorkingSpeed()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetAxisWorkingSpeed();
}
...
/*
 ...
 exam : >_CAX T 0 100
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetCustomAxisParam(ENG_RANC axis, UINT8 param, INT32 value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetCustomAxisParam(axis, param, value);
}
API_EXPORT BOOL uvEng_MDR_GetCustomAxisParam(ENG_RANC axis, UINT8 param)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetCustomAxisParam(axis, param);
}
...
/*
 ...
 exam : >_CPA 0 10
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetCustomGenericParam(UINT8 param, INT32 value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetCustomGenericParam(param, value);
}
API_EXPORT BOOL uvEng_MDR_GetCustomGenericParam(UINT8 param)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetCustomGenericParam(param);
}
...
/*
 ...
 exam : >_CAX T 0 100
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetCustomStationParam(CHAR station, UINT8 param, INT32 value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetCustomStationParam(station, param, value);
}
API_EXPORT BOOL uvEng_MDR_GetCustomStationParam(CHAR station, UINT8 param)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetCustomStationParam(station, param);
}
...
/*
 ...
 exam : None
*/
API_EXPORT BOOL uvEng_MDR_GetAllParamSetsSingleAxis(ENG_RANC axis)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetAllParamSetsSingleAxis(axis);
}
...
/*
 ...
 exam : None
*/
API_EXPORT BOOL uvEng_MDR_GetParameterSetInfo(UINT8 value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetParameterSetInfo(value);
}
...
/*
 ...
 exam : >SPD
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetHomingAllAxisMotionParam()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetHomingAllAxisMotionParam();
}
...
/*
 ...
 exam : >SPD
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetLoadedAllAxisMotionParam()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetLoadedAllAxisMotionParam();
}
...
/*
 ...
 exam : >SPD
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetWorkingAllAxisMotionParam()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetWorkingAllAxisMotionParam();
}
...
/*
 ...
 exam : >_AFE T
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_GetDistanceFromHomeSwitch(ENG_RANC axis)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetDistanceFromHomeSwitch(axis);
}
API_EXPORT BOOL uvEng_MDR_GetDistanceFromHomeSwitchEx(ENG_RANC axis)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetDistanceFromHomeSwitchEx(axis);
}
...
/*
 ...
 exam : >_FE T
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetFindEdgeAxis(ENG_RANC axis)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetFindEdgeAxis(axis);
}
...
/*
 ...
 exam : >_FH T
		>
*/
API_EXPORT BOOL uvEng_MDR_SetFindHomeSwitch(ENG_RANC axis)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetFindHomeSwitch(axis);
}
...
/*
 ...
 exam : >STA
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetHomeMethod(INT8 option)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetHomeMethod(option);
}
...
/*
 ...
 exam : >_HM Z
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_StartHomeAxis(ENG_RANC axis)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_StartHomeAxis(axis);
}
...
/*
 ...
 exam : >MTH R
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_MoveHomePosition(ENG_RANC axis)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_MoveHomePosition(axis);
}
...
/*
 ...
 exam : >CPO
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_MoveAxisAll(DOUBLE axis_t, DOUBLE axis_r1, DOUBLE axis_r2, DOUBLE axis_z)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_MoveAxisAll(axis_t, axis_r1, axis_r2, axis_z);
}
API_EXPORT BOOL uvEng_MDR_MoveAxisExtAll(DOUBLE axis_t, DOUBLE axis_r1, DOUBLE axis_r2, DOUBLE axis_z,
										 DOUBLE retract)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_MoveAxisExtAll(axis_t, axis_r1, axis_r2, axis_z, retract);
}
...
/*
 ...
 exam : >SPO A
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_MoveAxisRetractedPosition(CHAR station, UINT8 slot, UINT8 option)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_MoveAxisRetractedPosition(station, slot, option);
}
...
/*
 ...
 exam : >CPO R
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_MoveAbsolutePosition(ENG_RANC axis, DOUBLE position)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_MoveAbsolutePosition(axis, position);
}
...
/*
 ...
 exam : >CPO R
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_MoveRelativePosition(ENG_RANC axis, DOUBLE distance)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_MoveRelativePosition(axis, distance);
}
...
/*
 ...
 exam : >CPO
		...
		45
*/
API_EXPORT BOOL uvEng_MDR_MoveOverStraightLine(DOUBLE pos_t, DOUBLE pos_r)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_MoveOverStraightLine(pos_t, pos_r);
}
...
/*
 ...
 exam : >CPO
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_MoveOverTwoStraightLine(DOUBLE pos_t1, DOUBLE pos_r1, DOUBLE pos_t2, DOUBLE pos_r2)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_MoveOverTwoStraightLine(pos_t1, pos_r1, pos_t2, pos_r2);
}
...
/*
 ...
 exam : >MVTP
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetEELenRadiusForStationLessMove(DOUBLE ee_len, DOUBLE radius)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetEELenRadiusForStationLessMove(ee_len, radius);
}
...
/*
 ...
 exam : >HSA
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_StopMotionTask(ENG_RANC axis)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_StopMotionTask(axis);
}
...
/*
 ...
 exam : >GET a 1
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetWaitForMotionCompleted()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetWaitForMotionCompleted();
}
...
/*
 ...
 exam : >_CSS
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetCurrentStationSet(UINT8 value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetCurrentStationSet(value);
}
API_EXPORT BOOL uvEng_MDR_GetCurrentStationSet()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetCurrentStationSet();
}
...
/*
 ...
 exam : >PSH a
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetRAxisPusingAcceleration(CHAR station, DOUBLE value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetRAxisPusingAcceleration(station, value);
}
API_EXPORT BOOL uvEng_MDR_GetRAxisPusingAcceleration(CHAR station)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetRAxisPusingAcceleration(station);
}
API_EXPORT BOOL uvEng_MDR_GetRAxisPusingAccelerationDefault()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetRAxisPusingAccelerationDefault();
}
...
/*
 ...
 exam : >PSH a
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetRAxisPusingSpeed(CHAR station, DOUBLE value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetRAxisPusingSpeed(station, value);
}
API_EXPORT BOOL uvEng_MDR_GetRAxisPusingSpeed(CHAR station)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetRAxisPusingSpeed(station);
}
API_EXPORT BOOL uvEng_MDR_GetRAxisPusingSpeedDefault()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetRAxisPusingSpeedDefault();
}
...
/*
 ...
 exam : >SPO a
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetStationCoordCompensationSlot(CHAR station, ENG_RANC axis, DOUBLE value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetStationCoordCompensationSlot(station, axis, value);
}
API_EXPORT BOOL uvEng_MDR_GetStationCoordCompensationSlot(CHAR station)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetStationCoordCompensationSlot(station);
}
...
/*
 ...
 exam : >IST A
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_GetInlineStationApproachPosition(CHAR station)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetInlineStationApproachPosition(station);
}
...
/*
 ...
 exam : >COF A
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetStationCenterOffset(CHAR station, DOUBLE value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetStationCenterOffset(station, value);
}
API_EXPORT BOOL uvEng_MDR_GetStationCenterOffset(CHAR station)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetStationCenterOffset(station);
}
...
/*
 ...
 exam : >COFP A
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetStationCenterOffsetEdgeGrip(CHAR station, DOUBLE value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetStationCenterOffsetEdgeGrip(station, value);
}
API_EXPORT BOOL uvEng_MDR_GetStationCenterOffsetEdgeGrip(CHAR station)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetStationCenterOffsetEdgeGrip(station);
}
...
/*
 ...
 exam : >CST
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetStationSlotNo(CHAR station, UINT8 value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetStationSlotNo(station, value);
}
API_EXPORT BOOL uvEng_MDR_GetStationSlotNo(CHAR station)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetStationSlotNo(station);
}
...
/*
 ...
 exam : >NST
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetStationParamClear(CHAR station)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetStationParamClear(station);
}
API_EXPORT BOOL uvEng_MDR_SetStationParamClearAll()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetStationParamClearAll();
}
...
/*
 ...
 exam : >CST
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetCurrentStationName(CHAR station)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetCurrentStationName(station);
}
API_EXPORT BOOL uvEng_MDR_GetCurrentStationName()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetCurrentStationName();
}
...
/*
 ...
 exam : >_CSS
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetCurrentStationNo(UINT8 value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetCurrentStationNo(value);
}
API_EXPORT BOOL uvEng_MDR_GetCurrentStationNo()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetCurrentStationNo();
}
...
*/
API_EXPORT BOOL uvEng_MDR_SetDuplicateStationParamByName(CHAR source, CHAR target)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetDuplicateStationParamByName(source, target);
}
...
/*
 ...
 exam : >SPON 27
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetDuplicateStationParamByNumber(UINT8 source, UINT8 target)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetDuplicateStationParamByNumber(source, target);
}
...
/*
 ...
 exam : >EEN A 0
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetEndEffectorNumForStation(CHAR station, UINT8 number)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetEndEffectorNumForStation(station, number);
}
API_EXPORT BOOL uvEng_MDR_GetEndEffectorNumForStation(CHAR station)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetEndEffectorNumForStation(station);
}

/*
 desc : When the End Effector in the Station operation option GET or PUT the wafer to a specific position, set/return to move the Z axis up or down (cmd : eeo)
 parm : station	- [in]  Station Name (lower or uppoer case) (a ~ z or A ~ Z) (one character)
 ...
 exam : >EEO A 0
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetEndEffectorUpDownForStation(CHAR station, UINT8 up_down)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetEndEffectorUpDownForStation(station, up_down);
}
API_EXPORT BOOL uvEng_MDR_GetEndEffectorUpDownForStation(CHAR station)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetEndEffectorUpDownForStation(station);
}
...
/*
 ...
 exam : (station sets disabled)
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_GetEnumerateDefinedStations()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetEnumerateDefinedStations();
}
/*
 ...
 exam : 
*/
API_EXPORT BOOL uvEng_MDR_GetEnumerateDefinedStationsNum(UINT8 set)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetEnumerateDefinedStationsNum(set);
}
/*
 ...
 exam : 
*/
API_EXPORT BOOL uvEng_MDR_GetEnumerateDefinedStationsAll()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetEnumerateDefinedStationsAll();
}
/*
...
*/
API_EXPORT BOOL uvEng_MDR_GetEnumerateDefinedStationsAllNum()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetEnumerateDefinedStationsAllNum();
}
...
/*
 ...
 exam : >IST A
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetInlineStationLastSeqmentSpeedFactor(CHAR station, UINT8 value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetInlineStationLastSeqmentSpeedFactor(station, value);
}
API_EXPORT BOOL uvEng_MDR_GetInlineStationLastSeqmentSpeedFactor(CHAR station)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetInlineStationLastSeqmentSpeedFactor(station);
}
...
/*
 ...
 exam : >IRR A -4000
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetInlineStationRetractedRPosition(CHAR station, DOUBLE value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetInlineStationRetractedRPosition(station, value);
}
API_EXPORT BOOL uvEng_MDR_GetInlineStationRetractedRPosition(CHAR station)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetInlineStationRetractedRPosition(station);
}
...
/*
 ...
 exam : >IRT A 0
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetInlineStationRetractedTPosition(CHAR station, DOUBLE value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetInlineStationRetractedTPosition(station, value);
}
API_EXPORT BOOL uvEng_MDR_GetInlineStationRetractedTPosition(CHAR station)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetInlineStationRetractedTPosition(station);
}
...
/*
 ...
 exam : >ISA A 18000
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetInlineStationExitAngle(CHAR station, DOUBLE angle)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetInlineStationExitAngle(station, angle);
}
API_EXPORT BOOL uvEng_MDR_GetInlineStationExitAngle(CHAR station)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetInlineStationExitAngle(station);
}
...
/*
 ...
 exam : >ISD A 8000
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetInlineStationExitDistance(CHAR station, DOUBLE distance)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetInlineStationExitDistance(station, distance);
}
API_EXPORT BOOL uvEng_MDR_GetInlineStationExitDistance(CHAR station)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetInlineStationExitDistance(station);
}
...
/*
 ...
 exam : >ISE A 7500
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetInlineStationEndEffectLength(CHAR station, DOUBLE length)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetInlineStationEndEffectLength(station, length);
}
API_EXPORT BOOL uvEng_MDR_GetInlineStationEndEffectLength(CHAR station)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetInlineStationEndEffectLength(station);
}
...
/*
 ...
 exam : None
*/
API_EXPORT BOOL uvEng_MDR_SetInlineStationCornerRadius(CHAR station, DOUBLE radius)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetInlineStationCornerRadius(station, radius);
}
API_EXPORT BOOL uvEng_MDR_GetInlineStationCornerRadius(CHAR station)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetInlineStationCornerRadius(station);
}
...
/*
 ...
 exam : >IST A 1
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetInlineStationType(CHAR station, UINT8 type)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetInlineStationType(station, type);
}
API_EXPORT BOOL uvEng_MDR_GetInlineStationType(CHAR station)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetInlineStationType(station);
}
...
/*
 ...
 exam : >PGD A
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetPutGetDelayTime(CHAR station, UINT32 value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetPutGetDelayTime(station, value);
}
API_EXPORT BOOL uvEng_MDR_GetPutGetDelayTime(CHAR station)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetPutGetDelayTime(station);
}
...
/*
 ...
 exam : >PGO
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetPutGetFailureOption(CHAR station, UINT8 opt_get, UINT8 opt_put)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetPutGetFailureOption(station, opt_get, opt_put);
}
API_EXPORT BOOL uvEng_MDR_GetPutGetFailureOption(CHAR station)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetPutGetFailureOption(station);
}
...
/*
 ...
 exam : >PGO
		...
		?
*/
API_EXPORT BOOL uvEng_MDR_SetPutGetOption(UINT8 option)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetPutGetOption(option);
}
API_EXPORT BOOL uvEng_MDR_GetPutGetOption()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetPutGetOption();
}
...
/*
 ...
 exam : >PIT A 1875
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetStationPitch(CHAR station, DOUBLE value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetStationPitch(station, value);
}
API_EXPORT BOOL uvEng_MDR_GetStationPitch(CHAR station)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetStationPitch(station);
}
...
/*
 ...
 exam : >PSH a
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetStationPushingDist(CHAR station, DOUBLE value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetStationPushingDist(station, value);
}
API_EXPORT BOOL uvEng_MDR_GetStationPushingDist(CHAR station)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetStationPushingDist(station);
}
...
/*
 ...
 exam : >PSH a 0
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetStationPushingType(CHAR station, UINT8 value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetStationPushingType(station, value);
}
API_EXPORT BOOL uvEng_MDR_GetStationPushingType(CHAR station)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetStationPushingType(station);
}
...
>
 */
API_EXPORT BOOL uvEng_MDR_SetStartPushingOffsetR(CHAR station, DOUBLE value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetStartPushingOffsetR(station, value);
}
API_EXPORT BOOL uvEng_MDR_GetStartPushingOffsetR(CHAR station)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetStartPushingOffsetR(station);
}
...
/*
 ...
 exam : >PSH a
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetStartPushingOffsetZ(CHAR station, DOUBLE value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetStartPushingOffsetZ(station, value);
}
API_EXPORT BOOL uvEng_MDR_GetStartPushingOffsetZ(CHAR station)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetStartPushingOffsetZ(station);
}
...
/*
 ...
 exam : >PUA A 400
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetStationPickUpAccelerationZ(CHAR station, DOUBLE value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetStationPickUpAccelerationZ(station, value);
}
API_EXPORT BOOL uvEng_MDR_GetStationPickUpAccelerationZ(CHAR station)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetStationPickUpAccelerationZ(station);
}
...
/*
 ...
 exam : >PUS A 200
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetStationPickUpSpeedZ(CHAR station, DOUBLE value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetStationPickUpSpeedZ(station, value);
}
API_EXPORT BOOL uvEng_MDR_GetStationPickUpSpeedZ(CHAR station)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetStationPickUpSpeedZ(station);
}
...
/*
 ...
 exam : >RPO A
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetRetractedStationPositionR(CHAR station, DOUBLE value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetRetractedStationPositionR(station, value);
}
API_EXPORT BOOL uvEng_MDR_GetRetractedStationPositionR(CHAR station)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetRetractedStationPositionR(station);
}
...
/*
 ...
 exam : >SPO A
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetStationPositionName(CHAR station, ENG_RANC axis, DOUBLE value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetStationPositionName(station, axis, value);
}
API_EXPORT BOOL uvEng_MDR_GetStationPositionName(CHAR station)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetStationPositionName(station);
}
...
/*
 ...
 exam : >ENS N
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_GetStationPositionNumber(UINT8 station)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetStationPositionNumber(station);
}
...
/*
 ...
 exam : >STR A
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetStationStrokeZ(CHAR station, DOUBLE value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetStationStrokeZ(station, value);
}
API_EXPORT BOOL uvEng_MDR_GetStationStrokeZ(CHAR station)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetStationStrokeZ(station);
}
...
/*
 ...
 exam : >TMD 1
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetStationAxisOverlapFactor(UINT8 value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetStationAxisOverlapFactor(value);
}
API_EXPORT BOOL uvEng_MDR_GetStationAxisOverlapFactor()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetStationAxisOverlapFactor();
}
...
/*
 ...
 exam : >TCH A 25
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_StartTeachingStation(CHAR station, UINT8 slots)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_StartTeachingStation(station, slots);
}
...
/*
 ...
 exam : >TCH A 25
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetTeachingEnd()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetTeachingEnd();
}
...
/*
 ...
 exam :
*/
API_EXPORT BOOL uvEng_MDR_SetStationTrajectoryMode(UINT8 option)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetStationTrajectoryMode(option);
}
API_EXPORT BOOL uvEng_MDR_GetStationTrajectoryMode()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetStationTrajectoryMode();
}
...
/*
 ...
 exam : >VCHK
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetStationVacuumCheck(UINT8 option)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetStationVacuumCheck(option);
}
API_EXPORT BOOL uvEng_MDR_GetStationVacuumCheck()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetStationVacuumCheck();
}
...
/*
 ...
 exam : >VTO A
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetStationVacuumSearchTimeout(CHAR station, UINT32 value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetStationVacuumSearchTimeout(station, value);
}
API_EXPORT BOOL uvEng_MDR_GetStationVacuumSearchTimeout(CHAR station)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetStationVacuumSearchTimeout(station);
}
...
/*
 ...
 exam : >GET A 1
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetGetWaferFromStationName(CHAR station)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetGetWaferFromStationName(station);
}
API_EXPORT BOOL uvEng_MDR_SetGetWaferFromStationNameSlot(CHAR station, UINT8 slot)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetGetWaferFromStationNameSlot(station, slot);
}
API_EXPORT BOOL uvEng_MDR_SetGetWaferFromStationNameSlotOpt(CHAR station, UINT8 slot, UINT8 end_opt)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetGetWaferFromStationNameSlotOpt(station, slot, end_opt);
}
...
/*
 ...
 exam : >STA
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetGetWaferFromStationNameSlotDual(CHAR station, UINT8 arm, UINT8 slot)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetGetWaferFromStationNameSlotDual(station, arm, slot);
}
/*
 ...
 exam : >ENS N
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetGetWaferFromStationNum(UINT8 station)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetGetWaferFromStationNum(station);
}
API_EXPORT BOOL uvEng_MDR_SetGetWaferFromStationNumSlot(UINT8 station, UINT8 slot)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetGetWaferFromStationNumSlot(station, slot);
}
API_EXPORT BOOL uvEng_MDR_SetGetWaferFromStationNumSlotOpt(UINT8 station, UINT8 slot, UINT8 end_opt)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetGetWaferFromStationNumSlotOpt(station, slot, end_opt);
}
...
/*
 ...
 exam : >IST A
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetMoveOutStationArmOffsetZ(DOUBLE z_offset)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetMoveOutStationArmOffsetZ(z_offset);
}
API_EXPORT BOOL uvEng_MDR_SetMoveOutStation()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetMoveOutStation();
}
...
/*
 ...
 exam : >MSS A 1 B 1
		>
*/
API_EXPORT BOOL uvEng_MDR_SetMoveStationToStationByNameROffset(CHAR station_s, UINT8 slot_s,
															   CHAR station_t, UINT8 slot_t,
															   DOUBLE r_offset)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetMoveStationToStationByNameROffset(station_s, slot_s, station_t, slot_t, r_offset);
}
API_EXPORT BOOL uvEng_MDR_SetMoveStationToStationByName(CHAR station_s, UINT8 slot_s,
														CHAR station_t, UINT8 slot_t)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetMoveStationToStationByName(station_s, slot_s, station_t, slot_t);
}
...
/*
 ...
 exam : >ENS N
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetMoveStationToStationByNumberROffset(UINT8 station_s, UINT8 slot_s,
																 UINT8 station_t, UINT8 slot_t,
																 DOUBLE r_offset)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetMoveStationToStationByNumberROffset(station_s, slot_s, station_t, slot_t, r_offset);
}
API_EXPORT BOOL uvEng_MDR_SetMoveStationToStationByNumber(UINT8 station_s, UINT8 slot_s,
														  UINT8 station_t, UINT8 slot_t)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetMoveStationToStationByNumber(station_s, slot_s, station_t, slot_t);
}
...
/*
 ...
 exam :
*/
API_EXPORT BOOL uvEng_MDR_SetMoveArmStationApproachPosition(CHAR station, UINT8 slot, UINT8 option)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetMoveArmStationApproachPosition(station, slot, option);
}
...
/*
 ...
 exam : >SPO A
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetMoveArmStationPosition(CHAR station, UINT8 slot, UINT8 option)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetMoveArmStationPosition(station, slot, option);
}
...
/*
 ...
 exam : >NSL A
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetStationSlotNumber(CHAR station, UINT8 slot)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetStationSlotNumber(station, slot);
}
API_EXPORT BOOL uvEng_MDR_GetStationSlotNumber(CHAR station)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetStationSlotNumber(station);
}
...
/*
 ...
 exam : >NST
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_GetStationNumber()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetStationNumber();
}
...
/*
 ...
 exam : >OFS A
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetStationOffsetZ(CHAR station, DOUBLE value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetStationOffsetZ(station, value);
}
API_EXPORT BOOL uvEng_MDR_GetStationOffsetZ(CHAR station)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetStationOffsetZ(station);
}
...
/*
 ...
 exam : >GET A 1
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_PutWaferIntoStationName(CHAR station)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_PutWaferIntoStationName(station);
}
API_EXPORT BOOL uvEng_MDR_PutWaferIntoStationNameFull(CHAR station, UINT8 slot,
													  DOUBLE offset, UINT8 end_opt)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_PutWaferIntoStationNameFull(station, slot, offset, end_opt);
}
...
/*
 ...
 exam : >ENS N
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_PutWaferIntoStationNo(UINT8 station)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_PutWaferIntoStationNo(station);
}
API_EXPORT BOOL uvEng_MDR_PutWaferIntoStationNoFull(UINT8 station, UINT8 slot,
													DOUBLE offset, UINT8 end_opt)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_PutWaferIntoStationNoFull(station, slot, offset, end_opt);
}
...
/*
 ...
 exam : >STA
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_PutWaferIntoStationNameDual(CHAR station, UINT8 arm_no, UINT8 slot)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_PutWaferIntoStationNameDual(station, arm_no, slot);
}
...
/*
 ...
 exam : >STA
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetStationServiceBusy()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetStationServiceBusy();
}
...
/*
 ...
 exam : >STA
		...
		?
*/
API_EXPORT BOOL uvEng_MDR_SetMoveStationToStationEndOpt(CHAR station_s, UINT8 slot_s,
														CHAR station_t, UINT8 slot_t,
														DOUBLE r_offset, UINT8 end_opt)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetMoveStationToStationEndOpt(station_s, slot_s, station_t, slot_t,
											   r_offset, end_opt);
}
...
/*
 ...
 exam : >RPO A
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetStationLockedState(CHAR station, UINT8 option)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetStationLockedState(station, option);
}
API_EXPORT BOOL uvEng_MDR_GetStationLockedState(CHAR station)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetStationLockedState(station);
}
...
/*
 ...
 exam : >_MT
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetMaximumWaferThick(DOUBLE value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetMaximumWaferThick(value);
}
API_EXPORT BOOL uvEng_MDR_GetMaximumWaferThick()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetMaximumWaferThick();
}
...
/*
 ...
 exam : >_SA B
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetWaferScanZAxisAcceleration(CHAR station, DOUBLE value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetWaferScanZAxisAcceleration(station, value);
}
API_EXPORT BOOL uvEng_MDR_GetWaferScanZAxisAcceleration(CHAR station)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetWaferScanZAxisAcceleration(station);
}
...
/*
 ...
 exam : >_ST
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetCurrentPositionScanningCenterCoordinate(CHAR station)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetCurrentPositionScanningCenterCoordinate(station);
}
...
/*
 ...
 exam : >_ST
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetCurrentPositionScanningCoordinate(ENG_MALR direct, CHAR station)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetCurrentPositionScanningCoordinate(direct, station);
}
...
/*
 ...
 exam : >_SS B
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetWaferScanZAxisSpeed(CHAR station, DOUBLE value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetWaferScanZAxisSpeed(station, value);
}
API_EXPORT BOOL uvEng_MDR_GetWaferScanZAxisSpeed(CHAR station)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetWaferScanZAxisSpeed(station);
}
...
/*
 ...
 exam : >_ST
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetScannerSensorType(UINT8 value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetScannerSensorType(value);
}
API_EXPORT BOOL uvEng_MDR_GetScannerSensorType()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetScannerSensorType();
}
...
/*
 ...
 exam : >SCN B
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_GetScannedPositions(UINT8 direction)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetScannedPositions(direction);
}
...
/*
 ...
 exam : >SCN a
		...
		?
*/
API_EXPORT BOOL uvEng_MDR_GetResultLastWaferScanning(UINT8 direction)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetResultLastWaferScanning(direction);
}
...
*/
API_EXPORT BOOL uvEng_MDR_SetBeamThreadhold(DOUBLE value_l, DOUBLE value_h)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetBeamThreadhold(value_l, value_h);
}
API_EXPORT BOOL uvEng_MDR_GetBeamThreadhold()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetBeamThreadhold();
}
...
/*
 ...
 exam : >_BT
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetPerStationBeamThreadhold(CHAR station, DOUBLE value_l, DOUBLE value_h)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetPerStationBeamThreadhold(station, value_l, value_h);
}
API_EXPORT BOOL uvEng_MDR_GetPerStationBeamThreadhold(CHAR station)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetPerStationBeamThreadhold(station);
}
...
/*
 ...
 exam : >SCN a 0
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_StartStationWaferScanning(CHAR station, UINT8 direct, UINT8 angle)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_StartStationWaferScanning(station, direct, angle);
}
...
/*
 ...
 exam : >_ST
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetStationScanningCenterCoord(CHAR station, ENG_RANC axis, DOUBLE value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetStationScanningCenterCoord(station, axis, value);
}
API_EXPORT BOOL uvEng_MDR_GetStationScanningCenterCoord(CHAR station)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetStationScanningCenterCoord(station);
}
...
/*
 ...
 exam : >SCN A
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetScanDebugMode(UINT8 option)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetScanDebugMode(option);
}
...
/*
 ...
 exam : >_ST
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetStationScanningLeftCoord(CHAR station, ENG_RANC axis, DOUBLE value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetStationScanningLeftCoord(station, axis, value);
}
API_EXPORT BOOL uvEng_MDR_GetStationScanningLeftCoord(CHAR station)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetStationScanningLeftCoord(station);
}
...
/*
 ...
 exam : >_ST
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetStationScanningRightCoord(CHAR station, ENG_RANC axis, DOUBLE value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetStationScanningRightCoord(station, axis, value);
}
API_EXPORT BOOL uvEng_MDR_GetStationScanningRightCoord(CHAR station)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetStationScanningRightCoord(station);
}
...
/*
 ...
 exam : >_MT
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetStationWaferMaxThickness(CHAR station, DOUBLE value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetStationWaferMaxThickness(station, value);
}
API_EXPORT BOOL uvEng_MDR_GetStationWaferMaxThickness(CHAR station)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetStationWaferMaxThickness(station);
}
...
/*
 ...
 exam : >STA
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetPlaceStationToStationEndOpt(CHAR station_s, UINT8 slot_s,
														 CHAR station_t, UINT8 slot_t,
														 DOUBLE r_offset, UINT8 end_opt)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetPlaceStationToStationEndOpt(station_s, slot_s, station_t, slot_t,
												r_offset, end_opt);
}
...
/*
 ...
 exam : >SPO b
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetStationHighLowestCoordZ(UINT8 direct, CHAR station, DOUBLE value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetStationHighLowestCoordZ(direct, station, value);
}
API_EXPORT BOOL uvEng_MDR_GetStationHighLowestCoordZ(UINT8 direct, CHAR station)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetStationHighLowestCoordZ(direct, station);
}
...
/*
 ...
 exam : >TCS
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetStartTeachScanningParam()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetStartTeachScanningParam();
}
...
/*
 ...
 exam : >ACS
		...
		?
*/
API_EXPORT BOOL uvEng_MDR_GetOtFSetNumber()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetOtFSetNumber();
}
...
/*
 ...
 exam : >MTR P 1
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetOtFCentCalibRun(DOUBLE dist)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetOtFCentCalibRun(dist);
}
...
/*
 ...
 exam : None
*/
API_EXPORT BOOL uvEng_MDR_SetOtFNotchSecondScan(UINT8 option)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetOtFNotchSecondScan(option);
}
API_EXPORT BOOL uvEng_MDR_GetOtFNotchSecondScan()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetOtFNotchSecondScan();
}
...
/*
 ...
 exam : >ASL 5906 11500
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetOtFCaliRunStationDirection(CHAR station, UINT8 direct)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetOtFCaliRunStationDirection(station, direct);
}
API_EXPORT BOOL uvEng_MDR_SetOtFCaliRunStationDistance(CHAR station, UINT8 direct, DOUBLE dist)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetOtFCaliRunStationDistance(station, direct, dist);
}
...
/*
 ...
 exam : None
*/
API_EXPORT BOOL uvEng_MDR_SetOtFDebugLevel(INT8 value)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetOtFDebugLevel(value);
}
API_EXPORT BOOL uvEng_MDR_GetOtFDebugLevel()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetOtFDebugLevel();
}
...
/*
 ...
 exam : >AOFD 0
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetOtFDebugDump()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetOtFDebugDump();
}
...
/*
 ...
 exam : None
*/
API_EXPORT BOOL uvEng_MDR_SetOtFIgnoreMidSamples(UINT8 option)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetOtFIgnoreMidSamples(option);
}
API_EXPORT BOOL uvEng_MDR_GetOtFIgnoreMidSamples()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetOtFIgnoreMidSamples();
}
...
/*
 ...
 exam : >CPO
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetDualMoveArmAbsolutePositionR(DOUBLE position)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetDualMoveArmAbsolutePositionR(position);
}
...
/*
 ...
 exam : >CPO
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetDualMoveArmRelativeDistanceR(DOUBLE distance)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetDualMoveArmRelativeDistanceR(distance);
}
...
/*
 ...
 exam : >EEN A
		...
		>
*/
API_EXPORT BOOL uvEng_MDR_SetDualSelectMapperArm(CHAR station, UINT8 arm_no)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_SetDualSelectMapperArm(station, arm_no);
}
...
/*
 ...
 retn : TRUE or FALSE
*/
API_EXPORT BOOL uvCmn_MDR_IsValidSystemStatus()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return (0xffff == GetShMemMDR()->system_status);
}
...
/*
 ...
 retn : TRUE or FALSE
*/
API_EXPORT BOOL uvCmn_MDR_IsLastSendAckRecv()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_IsLastSendAckRecv();
}
...
/*
 ...
 retn : TRUE or FALSE
*/
API_EXPORT BOOL uvCmn_MDR_IsLastSendAckSucc()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_IsLastSendAckSucc();
}

/*
 desc : Whether the current Station is in service (Busy, Idle, Not defined 인지 여부. Only Station !!!)
 parm : None
 retn : TRUE or FALSE
*/
API_EXPORT BOOL uvCmn_MDR_IsStationServiceBusy()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_IsStationServiceBusy();
}
API_EXPORT BOOL uvCmn_MDR_IsStationServiceIdle()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_IsStationServiceIdle();
}
API_EXPORT BOOL uvCmn_MDR_IsStationServiceUndefined()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_IsStationServiceUndefined();
}
...
/*
 ...
 retn : TRUE or FALSE
*/
API_EXPORT BOOL uvCmn_MDR_GetSystemStatusMesg(TCHAR *mesg, UINT32 size)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetSystemStatusMesg(mesg, size);
}
...
/*
 ...
 retn : TRUE or FALSE
*/
API_EXPORT BOOL uvCmn_MDR_GetHomeSwitchStateMesg(TCHAR *mesg, UINT32 size)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetHomeSwitchStateMesg(mesg, size);
}
...
*/
API_EXPORT BOOL uvEng_MDR_GetExtErrorMesg(TCHAR *mesg, UINT32 size)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetExtErrorMesg(mesg, size);
}
...
/*
 ...
 retn : TRUE or FALSE
*/
API_EXPORT BOOL uvCmn_MDR_GetHomeSwitchesState(TCHAR *mesg, UINT32 size)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_GetHomeSwitchesState(mesg, size);
}
...
/*
 ...
 retn : TRUE or FALSE
*/
API_EXPORT BOOL uvCmn_MDR_IsWaitForMotionCompleted()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return GetShMemMDR()->motion_wait_finished == 0x00 ? FALSE : TRUE;
}
...
/*
 ...
 retn : TRUE or FALSE
*/
API_EXPORT BOOL uvCmn_MDR_IsMotorArmBusy()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	/* 아직 상태가 결정된 것이 없는 경우인지 ... */
	if (0xffff == GetShMemMDR()->system_status)	return TRUE;
	
	return 0x0100 == (GetShMemMDR()->system_status & 0x0100) ? TRUE : FALSE;
}
...
/*
 ...
 retn : TRUE or FALSE
*/
API_EXPORT BOOL uvCmn_MDR_IsMotorArmIdle()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	/* 아직 상태가 결정된 것이 없는 경우인지 ... */
	if (0xffff == GetShMemMDR()->system_status)	return 0x00;

	return 0x0000 == (GetShMemMDR()->system_status & 0x0100) ? FALSE : TRUE;
}
...
/*
 ...
 retn : TRUE or FALSE
*/
API_EXPORT UINT8 uvCmn_MDR_IsVacuumSwitchSensorAllOn()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;

	/* 아직 상태가 결정된 것이 없는 경우인지 ... */
	if (0xffff == GetShMemMDR()->system_status)	return 0x00;
	/* 000C : vacuumm switch on + vacuumm sensor on (정상 동작) */
	return (0x000C == (GetShMemMDR()->system_status & 0x000C) ? 0x01 : 0x02);
}
...
/*
 ...
 retn : TRUE or FALSE
*/
API_EXPORT BOOL uvCmn_MDR_IsRecvCmdData(ENG_RSCC cmd, ENG_RANC axis)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_IsRecvCmdData(cmd, axis);
}
API_EXPORT BOOL uvCmn_MDR_IsRecvCmdLast(ENG_RANC axis)
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_IsRecvCmdLast(axis);
}
...
/*
 ...
 retn : TRUE or FALSE
*/
API_EXPORT BOOL uvCmn_MDR_IsSystemError()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return FALSE;
	return uvMDR_IsSystemError();
}
#if 0
/*
...
*/
API_EXPORT UINT8 uvCmn_MDR_IsWaitMotionDoneReply()
{
	BOOL bError			= FALSE;
	LPG_MRDV pstShMem	= GetShMemMDR();

	/* 아직 상태가 결정된 것이 없는 경우인지 ... */
	if (0xffff == pstShMem->system_status)	return 0x00;

	/* STA CODE 값 분석 */
	if ((0x0100 == (pstShMem->system_status & 0x0100)) ||
		(0x0040 == (pstShMem->system_status & 0x0040)) ||
		(0x0001 == (pstShMem->system_status & 0x0001)))
	{
		/* Not ready */
		return 0x01;
	}
	/* 0000 : 완료 / 000C : vacuumm switch on + vacuumm sensor on (정상 동작) */
	else if (0x0000 == pstShMem->system_status ||
			 0x0100 == pstShMem->system_status ||
			 (0x000C == (pstShMem->system_status & 0x000C)))
	{
		/* Wafer OUT_BUFFER 감지 해제 && IN_BUFFER 감지 되면 이동 완료 */
		return 0x02;
	}
	/* Robot Error 일때 */
	else
	{
		if (!bError && 0x0002 == (pstShMem->system_status & 0x0002))	bError	= TRUE;
		if (!bError && 0x0010 == (pstShMem->system_status & 0x0010))	bError	= TRUE;
		if (!bError && 0x0020 == (pstShMem->system_status & 0x0020))	bError	= TRUE;
		if (!bError && 0x0200 == (pstShMem->system_status & 0x0200))	bError	= TRUE;
		if (!bError && 0x0400 == (pstShMem->system_status & 0x0400))	bError	= TRUE;
		if (!bError && 0x2000 == (pstShMem->system_status & 0x2000))	bError	= TRUE;
		
		if (bError)	return 0x03;
	}
...
API_EXPORT PTCHAR uvCmn_MDR_GetRecvLastString()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return NULL;
	CUniToChar csCnv;
	return csCnv.Ansi2Uni(GetShMemMDR()->last_string_data);
}
/* Returns the Retracted Position value according to the current Effector Number */
API_EXPORT DOUBLE uvCmn_MDR_GetRetractedPositionForEffectorNumber()
{
	if (!IsUseLib(ENG_EDIC::en_lsdr))	return 0.0f;
	return GetShMemMDR()->station_position[2];
}

/* Currently set custom station parameter (cmd : cst) */
API_EXPORT CHAR uvCmn_MDR_GetValueStationName()						{	return GetShMemMDR()->station_name;	}
/* Serial number of the robot (cmd : snr) */
API_EXPORT PCHAR uvCmn_MDR_GetValueSerialNumber()					{	return GetShMemMDR()->serial_number;	}
/* Current debug level, or calibration parameters (cmd : aofd) */
API_EXPORT INT8 uvCmn_MDR_GetValueOTFDebugLevel()					{	return GetShMemMDR()->otf_debug_level;	}
/* Currently set information mode, and option (cmd : inf) */
API_EXPORT UINT8 uvCmn_MDR_GetValueInfoMode()						{	return GetShMemMDR()->info_mode;	}
/* Currently set station set number (cmd : _css) */
API_EXPORT UINT8 uvCmn_MDR_GetValueStationSetNo()					{	return GetShMemMDR()->station_set_no;	}
/* Current station number (cmd : cstn) */
API_EXPORT UINT8 uvCmn_MDR_GetValueStationNo()						{	return GetShMemMDR()->station_no;	}
/* Current scanner type (cmd : _st) */
API_EXPORT UINT8 uvCmn_MDR_GetValueScannerType()					{	return GetShMemMDR()->scanner_type;	}
/* Current slot of a station (cmd : csl) */
API_EXPORT UINT8 uvCmn_MDR_GetValueCurrentSlotNo()					{	return GetShMemMDR()->current_slot_no;	}
/* Get end effector number in use for a station  (cmd : een) */
API_EXPORT UINT8 uvCmn_MDR_GetValueEndEffectorNum()					{	return GetShMemMDR()->end_effector_num;	}
/* Get end effector orientation (up or down) in use for a station  (cmd : eeo) */
API_EXPORT UINT8 uvCmn_MDR_GetValueEndEffectorStationUpDown()		{	return GetShMemMDR()->end_effector_up_down_station;	}
/* Get inline station type (cmd : IST) */
API_EXPORT UINT8 uvCmn_MDR_GetValueLinlineStationType()				{	return GetShMemMDR()->inline_station_type;	}
/* Current state of loaded parameters (cmd : lenb) */
API_EXPORT UINT8 uvCmn_MDR_GetValueLoadedSpeedEnable()				{	return GetShMemMDR()->loaded_speed_enable;	}
/* Number of slots of specified or default station (cmd : nsl) */
API_EXPORT UINT8 uvCmn_MDR_GetValueStationSlotNum()					{	return GetShMemMDR()->station_slot_num;	}
/* Number of stations (cmd : nst) */
API_EXPORT UINT8 uvCmn_MDR_GetValueStationNum()						{	return GetShMemMDR()->station_num;	}
/* Current value of station pusher type (cmd : psh) */
API_EXPORT UINT8 uvCmn_MDR_GetValuePusherType()						{	return GetShMemMDR()->pusher_type;	}
/* Numeric value, 0 or 1 (cmd : sbusy) */
API_EXPORT UINT8 uvCmn_MDR_GetValueStationServiceBusy()				{	return GetShMemMDR()->station_service_busy;	}
/* Current station lock state (cmd : slck) */
API_EXPORT UINT8 uvCmn_MDR_GetValueStationLockedState()				{	return GetShMemMDR()->station_locked_state;	}
/* Currently set motion overlap factor (cmd : tbl) */
API_EXPORT UINT8 uvCmn_MDR_GetValueStationAxisOverlapFactor()		{	return GetShMemMDR()->station_axis_overlap_factor;	}
/* Current wafer check options (cmd : vchk) */
API_EXPORT UINT8 uvCmn_MDR_GetValueStationTrajectoryMode()			{	return GetShMemMDR()->station_trajectory_mode;	}
/* 0: Wafer was not detected; 1: Wafer was detected (cmd : vst) if num=0 then top effector, else bottom effector */
API_EXPORT UINT8 uvCmn_MDR_GetValueEndEffectorWaferCheck(UINT8 num)	{	return GetShMemMDR()->end_effector_wafer_check[num];	}
/* Wait for Motion Completed (cmd : wmc) */
API_EXPORT UINT8 uvCmn_MDR_GetValueMotionWaitFinished()				{	return GetShMemMDR()->motion_wait_finished;	}
/* Current state of Check for notch on second scan (cmd : aofcn2) */
API_EXPORT UINT8 uvCmn_MDR_GetValueOTFSetSecondScanNotch()			{	return GetShMemMDR()->otf_set_second_scan_notch;	}
/* Current state of Ignore Middle Samples option (cmd : aofim) */
API_EXPORT UINT8 uvCmn_MDR_GetValueOTFIgnoreMiddleSamples()			{	return GetShMemMDR()->otf_ignore_middle_samples;	}
/* Currently set Scan Debug Mode (cmd : sdbg) */
API_EXPORT UINT8 uvCmn_MDR_GetValueScanDebugMode()					{	return GetShMemMDR()->scan_debug_mode;	}
/* Current arm used for scanning of specified station (cmd : see) */
API_EXPORT UINT8 uvCmn_MDR_GetValueArmUsedScanSpecStation()			{	return GetShMemMDR()->arm_used_scan_spec_station;	}
/* Current station type for the last station (cmd : ist) */
API_EXPORT UINT8 uvCmn_MDR_GetValueInlineStationType()				{	return GetShMemMDR()->inline_station_type;	}
/* Print-out of wafer map from last scanning, if available (cmd : map) */
API_EXPORT PUINT8 uvCmn_MDR_GetValueWaferMapLoadedState()			{	return GetShMemMDR()->wafer_map_loaded_state;	}
/* Currently set current limit of all axes (cmd : _cl) */
API_EXPORT PUINT8 uvCmn_MDR_GetValueCurrentLimit()					{	return GetShMemMDR()->current_limit;	}
/* Current state of Controlled Stop Feature. (cmd : cstp) */
API_EXPORT PUINT8 uvCmn_MDR_GetValueControlledStop()				{	return GetShMemMDR()->controlled_stop;	}
/* Current failure options (cmd : pgf) */
API_EXPORT PUINT8 uvCmn_MDR_GetValuePutGetFailedOption()			{	return GetShMemMDR()->put_get_failed_option;	}
/* Currently set Get option and T and Z axes synchronization mode (cmd : pgo) */
API_EXPORT PUINT8 uvCmn_MDR_GetValuePutGetOption()					{	return GetShMemMDR()->put_get_option;	}
/* Current wafer check options (cmd : vchk) */
API_EXPORT PUINT8 uvCmn_MDR_GetValueStationVacuumCheck()			{	return GetShMemMDR()->station_vacuum_check;	}
/* Absolute Encoder status (cmd : _aest) */
API_EXPORT PINT16 uvCmn_MDR_GetValueEncStatus()						{	return GetShMemMDR()->enc_status;	}
/* Low-level absolute encoder status (cmd : _ralmc) => Not perfect */
API_EXPORT UINT16 uvCmn_MDR_GetValueLowLevelEncStatus()				{	return GetShMemMDR()->low_level_enc_status;	}
/* Input state of all digital inputs (cmd : inp) */
API_EXPORT UINT16 uvCmn_MDR_GetValueDigitalInputState()				{	return GetShMemMDR()->digital_input_state;	}
/* Output state of all digital inputs (cmd : out) */
API_EXPORT UINT16 uvCmn_MDR_GetValueDigitalOutputState()			{	return GetShMemMDR()->digital_output_state;	}
/* All robot axes home switches state (cmd : rhs) */
API_EXPORT UINT16 uvCmn_MDR_GetValueHomeSwitchState()				{	return GetShMemMDR()->home_switch_state;	}
/* Error code from last failed command (cmd : eerr) */
API_EXPORT UINT16 uvCmn_MDR_GetValueExtendedErrorCode()				{	return GetShMemMDR()->extended_error_code;	}
/* Currently set on-the-fly set number (cmd : acs) */
API_EXPORT UINT16 uvCmn_MDR_GetValueOTFSetNumber()					{	return GetShMemMDR()->otf_set_number;	}
/* System status word (cmd : sta) */
API_EXPORT UINT16 uvCmn_MDR_GetValueSystemStatus()					{	return GetShMemMDR()->system_status;	}
/* Currently set time-out values (cmd : _bb) */
API_EXPORT PUINT16 uvCmn_MDR_GetValueBackupDCPower()				{	return GetShMemMDR()->backup_dc_power;	}
/* Currently set axis deceleration jerk (cmd : djk) (unit : um or degree or sec) */
API_EXPORT PUINT16 uvCmn_MDR_GetValueAxisDecelerationJerk()			{	return GetShMemMDR()->axis_deceleration_jerk;	}
/* Currently set axis acceleration jerk (cmd : ajk) (unit : um or degree or sec) */
API_EXPORT PUINT16 uvCmn_MDR_GetValueAxisAccelerationJerk()			{	return GetShMemMDR()->axis_acceleration_jerk;	}
/* Currently set axis acceleration jerk (cmd : lajk) (unit : um or degree or sec) */
API_EXPORT PUINT16 uvCmn_MDR_GetValueAxisLoadedAccelerationJerk()	{	return GetShMemMDR()->axis_loaded_acceleration_jerk;	}
/* Currently set axis deceleration jerk (cmd : ldjk) (unit : um or degree or sec) */
API_EXPORT PUINT16 uvCmn_MDR_GetValueAxisLoadedDecelerationJerk()	{	return GetShMemMDR()->axis_loaded_deceleration_jerk;	}
/* Currently set custom generic parameter (cmd : _cpa) */
API_EXPORT INT32 uvCmn_MDR_GetValueCustomGenericParam()				{	return GetShMemMDR()->custom_generic_param;	}
/* Currently set custom axis parameter (cmd : _cax) */
API_EXPORT INT32 uvCmn_MDR_GetValueCustomAxisParam()				{	return GetShMemMDR()->custom_axis_param;	}
/* Currently set custom station parameter (cmd : _cst) */
API_EXPORT INT32 uvCmn_MDR_GetValueCustomStationParam()				{	return GetShMemMDR()->custom_station_param;	}
/* Currently set position error limit of all axes (cmd : _el) */	
API_EXPORT PINT32 uvCmn_MDR_GetValuePositionErrorLimit()			{	return GetShMemMDR()->position_error_limit;	}
/* Input state of digital input (cmd : din) */
API_EXPORT UINT32 uvCmn_MDR_GetValueExternalDIInState()				{	return GetShMemMDR()->external_di_in_state;	}
/* Last state set to digital output (cmd : dout) */
API_EXPORT UINT32 uvCmn_MDR_GetValueExternalDIOutState()			{	return GetShMemMDR()->external_di_out_state;	}
/* Currently set delay (cmd : pgd) */
API_EXPORT UINT32 uvCmn_MDR_GetValuePutGetDelayTime()				{	return GetShMemMDR()->put_get_delay_time;	}
/* Currently set time out (cmd : vto) */
API_EXPORT UINT32 uvCmn_MDR_GetValueVacuumSearchTimeOut()			{	return GetShMemMDR()->vacuum_search_time_out;	}
/* Currently set differential coefficient of all axes (cmd : _hd) (unit : um or degree or sec) */
API_EXPORT PUINT32 uvCmn_MDR_GetValueAxisDiffCoeffHold()			{	return GetShMemMDR()->axis_diff_coeff_hold;	}
/* Currently set proportional coefficient of all axes (cmd : _kp) (unit : um or degree or sec) */
API_EXPORT PUINT32 uvCmn_MDR_GetValueAxisPropCoeff()				{	return GetShMemMDR()->axis_prop_coeff;	}
/* Currently set integral coefficient of all axes (cmd : _ki) (unit : um or degree or sec) */
API_EXPORT PUINT32 uvCmn_MDR_GetValueAxisInteCoeff()				{	return GetShMemMDR()->axis_inte_coeff;	}
/* Currently set differential coefficient of all axes (cmd : _kd) (unit : um or degree or sec) */
API_EXPORT PUINT32 uvCmn_MDR_GetValueAxisDiffCoeff()				{	return GetShMemMDR()->axis_diff_coeff;	}
/* Currently set proportional coefficient of all axes (cmd : _hp) (unit : um or degree or sec) */
API_EXPORT PUINT32 uvCmn_MDR_GetValueAxisPropCoeffHold()			{	return GetShMemMDR()->axis_prop_coeff_hold;	}
/* Currently set integral coefficient of all axes (cmd : _hi) (unit : um or degree or sec) */
API_EXPORT PUINT32 uvCmn_MDR_GetValueAxisInteCoeffHold()			{	return GetShMemMDR()->axis_inte_coeff_hold;	}
/* Currently set maximum wafer thickness (cmd : _mt) (unit : um or degree or sec) */
API_EXPORT DOUBLE uvCmn_MDR_GetValueMaximumWaferThick()				{	return GetShMemMDR()->maximum_wafer_thick;	}
/* Current value of R axis pushing acceleration (cmd : _pa - for default station) (unit : um or degree or sec) */
API_EXPORT DOUBLE uvCmn_MDR_GetValueRAxisPushAccDef()				{	return GetShMemMDR()->r_axis_push_acc_def;	}
/* Current value of R axis pushing acceleration (cmd : _pa - for last station) (unit : um or degree or sec) */
API_EXPORT DOUBLE uvCmn_MDR_GetValueRAxisPushAccSta()				{	return GetShMemMDR()->r_axis_push_acc_sta;	}
/* Current value of R axis pushing speed (cmd : _ps - for default station) (unit : um or degree or sec) */
API_EXPORT DOUBLE uvCmn_MDR_GetValueRAxisPushSpeedDef()				{	return GetShMemMDR()->r_axis_push_spd_def;	}
/* Current value of R axis pushing speed (cmd : _ps - for last station) (unit : um or degree or sec) */
API_EXPORT DOUBLE uvCmn_MDR_GetValueRAxisPushSpeedSTA()				{	return GetShMemMDR()->r_axis_push_spd_sta;	}
/* Current wafer scanning Z axis acceleration for given station (cmd : _sa) (unit : um or degree or sec) */
API_EXPORT DOUBLE uvCmn_MDR_GetValueWaferScanZAxisAcc()				{	return GetShMemMDR()->wafer_scan_z_axis_acc;	}
/* Current wafer scanning Z axis speed for given station (cmd : _ss) (unit : um or degree or sec) */
API_EXPORT DOUBLE uvCmn_MDR_GetValueWaferScanZAxisSpeed()			{	return GetShMemMDR()->wafer_scan_z_axis_spd;	}
/* Currently set center offset (cmd : cof) (unit : um or degree or sec) */
API_EXPORT DOUBLE uvCmn_MDR_GetValueStationCenterOffset()			{	return GetShMemMDR()->station_center_offset;	}
/* Currently set center offset (special operation) (cmd : cofp) (unit : um or degree or sec) */
API_EXPORT DOUBLE uvCmn_MDR_GetValueStationCenterOffsetEdgeGrip()	{	return GetShMemMDR()->station_center_offset_edge_grip;	}
/* Currently Inline Station Retracted R position for the default station (cmd : irr) (unit : um or degree or sec) */
API_EXPORT DOUBLE uvCmn_MDR_GetValueStationRetractedRPosition()		{	return GetShMemMDR()->station_retracted_r_position;	}
/* Currently Inline Station Retracted T position for the default station (cmd : irt) (unit : um or degree or sec) */
API_EXPORT DOUBLE uvCmn_MDR_GetValueStationRetractedTPosition()		{	return GetShMemMDR()->station_retracted_t_position;	}
/* Currently Inline Exit Angle for the default station (cmd : isa) (unit : um or degree or sec) */
API_EXPORT DOUBLE uvCmn_MDR_GetValueStationExitAngle()				{	return GetShMemMDR()->station_exit_angle;	}
/* Currently Inline Exit Distance for the last station (cmd : isd) (unit : um or degree or sec) */
API_EXPORT DOUBLE uvCmn_MDR_GetValueStationExitDistance()			{	return GetShMemMDR()->station_exit_distance;	}
/* Currently Inline Station End effector Length for the last station (cmd : ise) (unit : um or degree or sec) */
API_EXPORT DOUBLE uvCmn_MDR_GetValueStationEndEffectLength()		{	return GetShMemMDR()->station_end_effect_length;	}
/* Currently Inline Station Cornor Radius for the last station (cmd : isr) (unit : degreesec) */
API_EXPORT DOUBLE uvCmn_MDR_GetValueStationCornerRadius()			{	return GetShMemMDR()->station_corner_radius;	}
/* Currently set offset (cmd : ofs) (unit : um or degree or sec) */
API_EXPORT DOUBLE uvCmn_MDR_GetValueStationOffsetZ()				{	return GetShMemMDR()->station_offset_z;	}
/* Currently set pitch (cmd : pit) (unit : um or degree or sec) */
API_EXPORT DOUBLE uvCmn_MDR_GetValueStationPitch()					{	return GetShMemMDR()->station_pitch;	}
/* Current value of Start Pushing Distance (cmd : psd) (unit : um or degree or sec) */
API_EXPORT DOUBLE uvCmn_MDR_GetValueStartPushingDistance()			{	return GetShMemMDR()->start_pushing_distance;	}
/* Current value of Start Pushing Offset (cmd : pss) (unit : um or degree or sec) */
API_EXPORT DOUBLE uvCmn_MDR_GetValueStationStartPushingOffset()		{	return GetShMemMDR()->station_start_pushing_offset;	}
/* Current value of Z push offset (cmd : psz) (unit : um or degree or sec) */
API_EXPORT DOUBLE uvCmn_MDR_GetValueStationPushingOffsetZ()			{	return GetShMemMDR()->station_pushing_offset_z;	}
/* Currently set pickup acceleration (cmd : pua) (unit : um or degree or sec) */
API_EXPORT DOUBLE uvCmn_MDR_GetValueStationPickupAccelerationZ()	{	return GetShMemMDR()->station_pickup_acceleration_z;	}
/* Currently set pick-up speed (cmd : pus) (unit : um or degree or sec) */
API_EXPORT DOUBLE uvCmn_MDR_GetValueStationPickupSpeedZ()			{	return GetShMemMDR()->station_pickup_speed_z;	}
/* Currently set position (cmd : rpo) (unit : um or degree or sec) */
API_EXPORT DOUBLE uvCmn_MDR_GetValueStationRetractedPositionR()		{	return GetShMemMDR()->station_retracted_position_r;	}
/* Currently set maximum wafer thickness for Station (cmd : smt) (unit : um or degree or sec) */
API_EXPORT DOUBLE uvCmn_MDR_GetValueStationWaferMaxThickness()		{	return GetShMemMDR()->station_wafer_max_thickness;	}
/*Current Scanning Highest Z Position, for a given or default station  (cmd : szh) (unit : um or degree or sec) */
API_EXPORT DOUBLE uvCmn_MDR_GetValueStationScaningZHighestZCoord()	{	return GetShMemMDR()->station_scaning_highest_z_coord;	}
/* Current Scanning Lowest Z Position, for a given or default station (cmd : szl) (unit : um or degree or sec) */
API_EXPORT DOUBLE uvCmn_MDR_GetValueStationScaningZLowestCoord()	{	return GetShMemMDR()->station_scaning_lowest_z_coord;	}
/* Currently set stroke for z axis (cmd : str) (unit : um or degree or sec) */
API_EXPORT DOUBLE uvCmn_MDR_GetValueStationStrokeZ()				{	return GetShMemMDR()->station_stroke_z;	}
/* Currently set maximum beam thresholds for Global (cmd : _bt) (unit : um or degree or sec) */
API_EXPORT PDOUBLE uvCmn_MDR_GetValueBeamThreshold()				{	return GetShMemMDR()->beam_threshold;	}
/* Currently set maximum beam thresholds for Station (cmd : sbt) (unit : um or degree or sec) */
API_EXPORT PDOUBLE uvCmn_MDR_GetValueStationBeamThreshold()			{	return GetShMemMDR()->station_per_beam_threshold;	}
/* Currently set station position (cmd : spo or spon) (unit : um or degree or sec) */
API_EXPORT PDOUBLE uvCmn_MDR_GetValueStationPosition()				{	return GetShMemMDR()->station_position;	}
/* Current Scanning Right Coordinate, for all or given axis (cmd : srp) (unit : um or degree or sec) */
API_EXPORT PDOUBLE uvCmn_MDR_GetValueStationScanningRightCoord()	{	return GetShMemMDR()->station_scanning_right_coord;	}
/* Current Scanning Left Coordinate, for all or given axis (cmd : slp) (unit : um or degree or sec) */
API_EXPORT PDOUBLE uvCmn_MDR_GetValueStationScanningLeftCoord()		{	return GetShMemMDR()->station_scanning_left_coord;	}
/* Current Scanning Center Coordinate, for all or given axis (cmd : scp) (unit : um or degree or sec) */
API_EXPORT PDOUBLE uvCmn_MDR_GetValueStationScanningCenterCoord()	{	return GetShMemMDR()->station_scanning_center_coord;	}
/* Currently set maximum beam thresholds for Station (cmd : sbt) (unit : um or degree or sec) */
API_EXPORT PDOUBLE uvCmn_MDR_GetValueStationPerBeamThreshold()		{	return GetShMemMDR()->station_per_beam_threshold;	}
/* Current position of all axes (cmd : cpo) (unit : um or degree or sec) */
API_EXPORT PDOUBLE uvCmn_MDR_GetValueAxisCurrentPosition()			{	return GetShMemMDR()->axis_current_position;	}
/* Currently set integral limit of all axes (cmd : _il) (unit : um or degree or sec) */
API_EXPORT PDOUBLE uvCmn_MDR_GetValueAxisIntegralLimit()			{	return GetShMemMDR()->axis_integral_limit;	}
/* Currently set integral limit of all axes (cmd : _hl) (unit : um or degree or sec) */
API_EXPORT PDOUBLE uvCmn_MDR_GetValueAxisInteLimitHold()			{	return GetShMemMDR()->axis_inte_limit_hold;	}
/* Currently set position error limit of all axes (cmd : _he) (unit : um or degree or sec) */
API_EXPORT PDOUBLE uvCmn_MDR_GetValuePosErrLimitHold()				{	return GetShMemMDR()->pos_err_limit_hold;	}
/* Currently set Reverse safe envelope position for all the axes (cmd : _rse) (unit : um or degree or sec) */
API_EXPORT PDOUBLE uvCmn_MDR_GetValueAxisSafeEnvelopReverse()		{	return GetShMemMDR()->axis_safe_envelop_reverse;	}
/* Currently set forward safe envelope position for all the axes (cmd : _fse) (unit : um or degree or sec) */
API_EXPORT PDOUBLE uvCmn_MDR_GetValueAxisSafeEnvelopForward()		{	return GetShMemMDR()->axis_safe_envelop_forward;	}
/* Currently set axis speed (cmd : spd) (unit : um or degree or sec) */
API_EXPORT PDOUBLE uvCmn_MDR_GetValueAxisWorkingSpeed()				{	return GetShMemMDR()->axis_working_speed;	}
/* Currently set loaded speed (cmd : lspd) (unit : um or degree or sec) */
API_EXPORT PDOUBLE uvCmn_MDR_GetValueAxisLoadedSpeed()				{	return GetShMemMDR()->axis_loaded_speed;	}
/* Currently set loaded acceleration (cmd : ldcl) (unit : um or degree or sec) */
API_EXPORT PDOUBLE uvCmn_MDR_GetValueAxisLoadedDeceleration()		{	return GetShMemMDR()->axis_loaded_deceleration;	}
/* Currently set loaded acceleration (cmd : lacl) (unit : um or degree or sec) */
API_EXPORT PDOUBLE uvCmn_MDR_GetValueAxisLoadedAcceleration()		{	return GetShMemMDR()->axis_loaded_acceleration;	}
/* Currently set axis deceleration (cmd : dcl) (unit : um or degree or sec) */
API_EXPORT PDOUBLE uvCmn_MDR_GetValueAxisDeceleration()				{	return GetShMemMDR()->axis_deceleration;	}
/* Currently set axis acceleration (cmd : acl) (unit : um or degree or sec) */
API_EXPORT PDOUBLE uvCmn_MDR_GetValueAxisAcceleration()				{	return GetShMemMDR()->axis_acceleration;	}
/* Currently offset compensation with slot (cmd : _zc) (unit : um or degree or sec) */
API_EXPORT PDOUBLE uvCmn_MDR_GetValueCoordCompensationSlot()		{	return GetShMemMDR()->coord_compensation_slot;	}
/* Currently set Reverse direction software limits for all the axes (cmd : _rl) (unit : um or degree or sec) */
API_EXPORT PDOUBLE uvCmn_MDR_GetValueSWNegativeLimit()				{	return GetShMemMDR()->sw_negative_limit;	}
/* Currently set forward direction software limit for all the axes (cmd : _fl) (unit : um or degree or sec) */
API_EXPORT PDOUBLE uvCmn_MDR_GetValueSWPositiveLimit()				{	return GetShMemMDR()->sw_positive_limit;	}
/* Currently set encoder zero offsets of all the axes (cmd : _eor) (unit : um or degree or sec) */
API_EXPORT PDOUBLE uvCmn_MDR_GetValueEncZeroOffset()				{	return GetShMemMDR()->enc_zero_offset;	}
/* Currently set customized home position of all the axes (cmd : _ch) (unit : um or degree or sec) */
API_EXPORT PDOUBLE uvCmn_MDR_GetValueHomedPosition()				{	return GetShMemMDR()->homed_position;	}
