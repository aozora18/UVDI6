...
/*
 desc : Prealigner returns full information
 parm : None
 retn : Prealigner A pointer to a structure that stores all information
*/
LPG_MPDV GetShMemMPA()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return NULL;
...
/*
 ...
 retn : TRUE or FALSE
*/
API_EXPORT BOOL uvEng_MPA_IsConnected()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_IsConnected();
}
...
/*
 ...
 retn : TRUE or FALSE
*/
API_EXPORT BOOL uvEng_MPA_IsInitialized()
{
	return uvMPA_IsInitialized();
}
...
/*
 ...
 retn : None
*/
API_EXPORT VOID uvEng_MPA_ResetCommData()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return;
	return 	uvMPA_ResetCommData();
}
...
*/
API_EXPORT ENG_MSAS uvEng_MPA_GetLastSendAckStatus()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return ENG_MSAS::none;
	return uvMPA_GetLastSendAckStatus();
}
...
*/
API_EXPORT UINT32 uvEng_MPA_GetRecvSize()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_GetRecvSize();
}
...
/*
 ...
 exam : >INF 1
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_SetInfoMode(/*Internal : 0x01*/)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_SetInfoMode(0x01);
}
API_EXPORT BOOL uvEng_MPA_GetInfoMode()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_GetInfoMode();
}
...
/*
 ...
 exam : >MCPO R
		...
		900,1000,2000
*/
API_EXPORT BOOL uvEng_MPA_GetAxisPos()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_GetAxisPos();
}
...
*/
API_EXPORT BOOL uvEng_MPA_GetDiagState()
{
	/* 현재 상태 정보 요청 */
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_GetDiagState();
}
...
/*
 ...
 exam : >EST
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_GetMotionState()
{
	/* 현재 상태 정보 요청 */
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_GetMotionState();
}
...
/*
 ...
 exam : >INF
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_GetErrorReason()
{
	/* 현재 상태 정보 요청 */
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_GetErrorReason();
}
...
/*
 ...
 exam : >RHS
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_GetAllSwitchState()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_GetAllSwitchState();
}
...
/*
 ...
 exam : >INF 0
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_GetSystemStatus()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_GetSystemStatus();
}
...
/*
 ...
 exam : >VER S
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_GetVerModuleAll()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_GetVerModuleAll();
}
...
/*
 ...
 exam : >_CH
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_GetAxisHomePosition()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_GetAxisHomePosition();
}
API_EXPORT BOOL uvEng_MPA_SetAxisHomePosition(ENG_PANC axis, DOUBLE value)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_SetAxisHomePosition(axis, value);
}
/*
 ...
 retn : TRUE or FALSE
 */
API_EXPORT BOOL uvEng_MPA_SetAxisCurHomePosition(ENG_PANC axis)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_SetAxisCurHomePosition(axis);
}
...
/*
 ...
 exam : >_CL
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_GetAxisCurrentLimit()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_GetAxisCurrentLimit();
}
API_EXPORT BOOL uvEng_MPA_SetAxisCurrentLimit(ENG_PANC axis, UINT8 value)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_SetAxisCurrentLimit(axis, value);
}
...
/*
 ...
 exam : >_EL
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_GetAxisPositionLimitError()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_GetAxisPositionLimitError();
}
API_EXPORT BOOL uvEng_MPA_SetAxisPositionLimitError(ENG_PANC axis, UINT16 value)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_SetAxisPositionLimitError(axis, value);
}
...
/*
 ...
 exam : >_RL
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_GetAxisDirectLimit(ENG_MAMD direct)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_GetAxisDirectLimit(direct);
}
API_EXPORT BOOL uvEng_MPA_SetAxisDirectLimit(ENG_PANC axis, ENG_MAMD direct, DOUBLE value)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_SetAxisDirectLimit(axis, direct, value);
}
...
/*
 ...
 exam : >_HO
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_GetAxisHomeOffset()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_GetAxisHomeOffset();
}
API_EXPORT BOOL uvEng_MPA_SetAxisHomeOffset(ENG_PANC axis, DOUBLE value)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_SetAxisHomeOffset(axis, value);
}
API_EXPORT BOOL uvEng_MPA_SetAxisCurHomeOffset(ENG_PANC axis)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_SetAxisCurHomeOffset(axis);
}
...
/*
 ...
 exam : >ACL T 48000
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_GetAxisInstSpeed(ENG_MAST type)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_GetAxisInstSpeed(type);
}
API_EXPORT BOOL uvEng_MPA_SetAxisInstSpeed(ENG_PANC axis, ENG_MAST type, DOUBLE value)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_SetAxisInstSpeed(axis, type, value);
}
...
/*
 ...
 exam : >AJK T 600
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_GetAxisJerkSpeed(ENG_MAST type)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_GetAxisJerkSpeed(type);
}
API_EXPORT BOOL uvEng_MPA_SetAxisJerkSpeed(ENG_PANC axis, ENG_MAST type, DOUBLE value)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_SetAxisJerkSpeed(axis, type, value);
}
...
/*
 ...
 exam : >PRO T
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_GetVelocityProfile()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_GetVelocityProfile();
}
API_EXPORT BOOL uvEng_MPA_SetVelocityProfile(ENG_PANC axis, UINT8 profile)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_SetVelocityProfile(axis, profile);
}
...
/*
 ...
 exam : >SPD T 4800
		...
		4800,500,500
*/
API_EXPORT BOOL uvEng_MPA_GetAxisSpeed()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_GetAxisSpeed();
}
API_EXPORT BOOL uvEng_MPA_SetAxisSpeed(ENG_PANC axis, DOUBLE speed)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_SetAxisSpeed(axis, speed);
}
...
/*
 ...
 exam : >_LU 4475
		...
		0,0,4475
*/
API_EXPORT BOOL uvEng_MPA_SetAxisAllHoming()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_SetAxisAllHoming();
}
...
/*
 ...
 exam : >MTH R
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_MoveHomePosition(ENG_PANC axis)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_MoveHomePosition(axis);
}
...
/*
 ...
 exam : >MCPO R
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_MoveToAxis(ENG_PANC axis, ENG_PAMT type, DOUBLE value)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_MoveToAxis(axis, type, value);
}
...
/*
 ...
 exam : >SOF R
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_ServoControl(ENG_PANC axis, ENG_PSOO type)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_ServoControl(axis, type);
}
...
/*
 ...
 exam : >STP R
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_StopToAxis(ENG_PANC axis)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_StopToAxis(axis);
}
...
/*
 ...
 exam : >MVR R 500
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_WaitPrealigner(ENG_PANC axis)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_WaitPrealigner(axis);
}
...
/*
 ...
 exam : >MCVF
		>
*/
API_EXPORT BOOL uvEng_MPA_ChuckVacuum(ENG_PSOO type)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_ChuckVacuum(type);
}
...
/*
 ...
 retn : TRUE or FALSE
*/
API_EXPORT BOOL uvEng_MPA_PinsVacuum(ENG_PSOO type)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_PinsVacuum(type);
}

/*
 desc : Start alignment (cmd : bal)
 parm : bal_mode	- [in]  Only 0, 2, 3, 4, 5 (except to 1)
 ...
 exam : >BAL
		...
		>0000
*/
API_EXPORT BOOL uvEng_MPA_FindNotchAngle(DOUBLE max_offset/*0.0*/, UINT8 offset_try/*0*/,
										 DOUBLE max_angle/*0.0*/, UINT8 angle_try/*0*/, UINT8 orient_notch/*0*/)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_FindNotchAngle(max_offset, offset_try, max_angle, angle_try, orient_notch);
}
API_EXPORT BOOL uvEng_MPA_FindNotchAngleExt(UINT8 mode)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_FindNotchAngleExt(mode);
}
/*
 ...
 exam : >CCD
		2450
*/
API_EXPORT BOOL uvEng_MPA_GetCCDSensorPixels()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_GetCCDSensorPixels();
}
API_EXPORT BOOL uvEng_MPA_SetCCDSensorPixels(UINT16 value)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_SetCCDSensorPixels(value);
}
...
/*
 ...
 exam : >DOC 0
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_CheckWaferLoaded()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_CheckWaferLoaded();
}
...
/*
 ...
 exam : >FWO
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_SetRotationAfterAlign(DOUBLE angle)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_SetRotationAfterAlign(angle);
}
API_EXPORT BOOL uvEng_MPA_GetRotationAfterAlign()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_GetRotationAfterAlign();
}
...
/*
 ...
 exam : >LTC
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_SetWaferPlaceType(ENG_PWPT type)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_SetWaferPlaceType(type);
}
API_EXPORT BOOL uvEng_MPA_GetWaferPlaceType()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_GetWaferPlaceType();
}
...
/*
 ...
 exam : >BAL
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_GetWaferNotchCount(ENG_PASR type)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_GetWaferNotchCount(type);
}
...
/*
 ...
 exam : >_MND 35
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_GetWaferAlignDepthWidth(INT16 index)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_GetWaferAlignDepthWidth(index);
}
...
/*
 ...
 exam : >_MND
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_GetWaferFindNotchRange(ENG_PNTI type, UINT8 kind)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_GetWaferFindNotchRange(type, kind);
}
API_EXPORT BOOL uvEng_MPA_SetWaferFindNotchRange(ENG_PNTI type, UINT8 kind, UINT32 range)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_SetWaferFindNotchRange(type, kind, range);
}
...
/*
 ...
 exam : >_MGD
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_GetMinCCDSampleCount()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_GetMinCCDSampleCount();
}
API_EXPORT BOOL uvEng_MPA_SetMinCCDSampleCount(UINT16 samples)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_SetMinCCDSampleCount(samples);
}
...
/*
 ...
 exam : >_MAXWSZ
		...
		?
*/
API_EXPORT BOOL uvEng_MPA_SetWaferMinMaxSize(ENG_MMMR type, ENG_MWKT kind)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_SetWaferMinMaxSize(type, kind);
}
API_EXPORT BOOL uvEng_MPA_GetWaferMinMaxSize(ENG_MMMR type)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_GetWaferMinMaxSize(type);
}
...
/*
 ...
 exam : >WSZ
		...
		?
*/
API_EXPORT BOOL uvEng_MPA_SetWaferWorkSize(ENG_MWKT kind)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_SetWaferWorkSize(kind);
}
API_EXPORT BOOL uvEng_MPA_GetWaferWorkSize()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_GetWaferWorkSize();
}
...
/*
 ...
 exam : >WSZ
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_SetWaferWorkLight(UINT8 light)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_SetWaferWorkLight(light);
}
API_EXPORT BOOL uvEng_MPA_GetWaferWorkLight()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_GetWaferWorkLight();
}
...
/*
 ...
 exam : >MRWI
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_GetWaferCenterOrientation()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_GetWaferCenterOrientation();
}
...
/*
 ...
 exam : >_ASZ
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_SetAutoDetectWaferSize(ENG_PWSD type)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_SetAutoDetectWaferSize(type);
}
API_EXPORT BOOL uvEng_MPA_GetAutoDetectWaferSize()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_GetAutoDetectWaferSize();
}
...
/*
 ...
 exam : >_AUTOSCANAGAIN
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_SetAutoScanAgain(ENG_MFED type)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_SetAutoScanAgain(type);
}
API_EXPORT BOOL uvEng_MPA_GetAutoScanAgain()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_GetAutoScanAgain();
}
...
/*
 ...
 exam : >_FINALVACC
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_SetVacuumSetAfterBAL(ENG_PSOO type)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_SetVacuumSetAfterBAL(type);
}
API_EXPORT BOOL uvEng_MPA_GetVacuumSetAfterBAL()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_GetVacuumSetAfterBAL();
}
...
/*
 ...
 exam : >MGLM
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_SetWaferGlassType(ENG_PWGO type)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_SetWaferGlassType(type);
}
API_EXPORT BOOL uvEng_MPA_GetWaferGlassType()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_GetWaferGlassType();
}
...
/*
 ...
 exam : >_LD
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_GetWaferLoadPosition(ENG_PWLP type)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_GetWaferLoadPosition(type);
}
API_EXPORT BOOL uvEng_MPA_SetWaferLoadPosition(ENG_PANC axis, ENG_PWLP type, DOUBLE pos)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_SetWaferLoadPosition(axis, type, pos);
}
...
/*
 ...
 exam : >_MA
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_GetMeasureAccDcl(ENG_MAST type)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_GetMeasureAccDcl(type);
}
API_EXPORT BOOL uvEng_MPA_SetMeasureAccDcl(ENG_PANC axis, ENG_MAST type, DOUBLE value)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_SetMeasureAccDcl(axis, type, value);
}
...
/*
 ...
 exam : >_MS
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_GetMeasureSpeedAxis()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_GetMeasureSpeedAxis();
}
API_EXPORT BOOL uvEng_MPA_SetMeasureSpeedAxis(ENG_PANC axis, DOUBLE value)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_SetMeasureSpeedAxis(axis, value);
}
...
/*
 ...
 exam : >_NOTCHDEPTHMODE
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_GetNotchDepthMode()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_GetNotchDepthMode();
}
API_EXPORT BOOL uvEng_MPA_SetNotchDepthMode(bool enable)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_SetNotchDepthMode(enable);
}
...
/*
 ...
 exam : >_MP
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_SetWaferAlignmentMeasuringPos()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_SetWaferAlignmentMeasuringPos();
}
...
/*
 ...
 exam : >MCPO
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_SetWaferLoadingPos()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_SetWaferAlignmentLoadingPos();
}
...
/*
 ...
 exam : >_MTPMODE
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_GetModeZAfterMovePins()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_GetModeZAfterMovePins();
}
API_EXPORT BOOL uvEng_MPA_SetModeZAfterMovePins(ENG_PWLP mode)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_SetModeZAfterMovePins(mode);
}
...
/*
 ...
 exam : >_PP
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_GetLevelChcukToPinsPosZ()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_GetLevelChcukToPinsPosZ();
}
API_EXPORT BOOL uvEng_MPA_SetLevelChcukToPinsPosZ(DOUBLE value)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_SetLevelChcukToPinsPosZ(value);
}
...
/*
 ...
 exam : >_PPCD
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_GetOffsetChcukToPinsPosZ(ENG_PWLP type)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_GetOffsetChcukToPinsPosZ(type);
}
API_EXPORT BOOL uvEng_MPA_SetOffsetChcukToPinsPosZ(ENG_PWLP type, DOUBLE value)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_SetOffsetChcukToPinsPosZ(type, value);
}
...
/*
 ...
 exam : >_SA
		...
		400
*/
API_EXPORT BOOL uvEng_MPA_GetAngleRAxisToCCD()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_GetAngleRAxisToCCD();
}
API_EXPORT BOOL uvEng_MPA_SetAngleRAxisToCCD(DOUBLE value)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_SetAngleRAxisToCCD(value);
}
...
/*
 ...
 exam : >_SAM
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_GetNotchAverageMode()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_GetNotchAverageMode();
}
API_EXPORT BOOL uvEng_MPA_SetNotchAverageMode(BOOL enable)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_SetNotchAverageMode(enable);
}
...
/*
 ...
 exam : >_SC
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_GetCCDSensorCenter()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_GetCCDSensorCenter();
}
API_EXPORT BOOL uvEng_MPA_SetCCDSensorCenter(UINT32 pixel)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_SetCCDSensorCenter(pixel);
}
...
/*
 ...
 exam : >_SM 2
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_GetRotationSampleMode()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_GetRotationSampleMode();
}
API_EXPORT BOOL uvEng_MPA_SetRotationSampleMode(ENG_PRSM mode)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_SetRotationSampleMode(mode);
}
...
/*
 ...
 exam : >_SP
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_GetStopOnPins()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_GetStopOnPins();
}
API_EXPORT BOOL uvEng_MPA_SetStopOnPins(UINT8 mode)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_SetStopOnPins(mode);
}
...
/*
 ...
 exam : >_SQMAX
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_GetSuqreValueOfCCD(ENG_MMMR mode)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_GetSuqreValueOfCCD(mode);
}
API_EXPORT BOOL uvEng_MPA_SetSuqreValueOfCCD(ENG_MMMR mode, UINT32 area)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_SetSuqreValueOfCCD(mode, area);
}
...
/*
 ...
 exam : >_TD
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_GetWaferTranserSafePos(ENG_PWLP mode)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_GetWaferTranserSafePos(mode);
}
API_EXPORT BOOL uvEng_MPA_SetWaferTranserSafePos(ENG_PWLP mode, DOUBLE value)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_SetWaferTranserSafePos(mode, value);
}
...
/*
 ...
 exam : >_TO 0
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_GetParamTimeOut(UINT8 param)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_GetParamTimeOut(param);
}
API_EXPORT BOOL uvEng_MPA_SetParamTimeOut(UINT8 param, UINT32 value)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_SetParamTimeOut(param, value);
}
...
/*
 ...
 exam : >_WSZ
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_SetAssingAutoLoadWafer(INT8 set, ENG_MWKT wafer)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_SetAssingAutoLoadWafer(set, wafer);
}
...
/*
 ...
 exam : >_WT
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_GetWaferType()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_GetWaferType();
}
API_EXPORT BOOL uvEng_MPA_SetWaferType(ENG_PGWT type)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_SetWaferType(type);
}
...
/*
 ...
 exam : >WPS 1
		>
*/
API_EXPORT BOOL uvEng_MPA_RestorePerformSetFile(UINT8 set_no)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_RestorePerformSetFile(set_no);
}
API_EXPORT BOOL uvEng_MPA_WritePerformSetFile(UINT8 set_no)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_WritePerformSetFile(set_no);
}
...
exam : None
*/
API_EXPORT BOOL uvEng_MPA_RestoreParamSetFile()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_RestoreParamSetFile();
}
...
/*
 ...
 exam : None
*/
API_EXPORT BOOL uvEng_MPA_SaveParamSetFile()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_SaveParamSetFile();
}
...
/*
 ...
 exam : None
*/
API_EXPORT BOOL uvEng_MPA_RestoreParamSetMemory()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_RestoreParamSetMemory();
}
...
/*
 ...
 exam : None
*/
API_EXPORT BOOL uvEng_MPA_SaveParamSetMemory()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_SaveParamSetMemory();
}
...
/*
 ...
 exam : >_DT
		System date: 2006-10-9, System time: 22:17:57
		>_DT 20170115 154520
		System date: 2017-1-15, System time: 15:45:20
		>
*/
API_EXPORT BOOL uvEng_MPA_GetSystemTime()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_GetSystemTime();
}
API_EXPORT BOOL uvEng_MPA_SetSystemTime()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_SetSystemTime();
}
...
/*
 ...
 exam : >SPD
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_RestoreTrajectorySpeedAcc(UINT8 mode)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_RestoreTrajectorySpeedAcc(mode);
}
...
/*
 ...
 exam : >RES
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_ResetPrealigner()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_ResetPrealigner();
}
...
/*
 ...
 exam : >_AUTODUMPS
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_GetAlignFailAutoDumps()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_GetAlignFailAutoDumps();
}
API_EXPORT BOOL uvEng_MPA_SetAlignFailAutoDumps(UINT8 mode)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_SetAlignFailAutoDumps(mode);
}
...
/*
 ...
 exam : >_AUTODUMPSF
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_GetAlignFailAutoDumpFile()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_GetAlignFailAutoDumpFile();
}
API_EXPORT BOOL uvEng_MPA_SetAlignFailAutoDumpFile(UINT8 file_no)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_SetAlignFailAutoDumpFile(file_no);
}
...
/*
 ...
 exam : >SON
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_SetPhysicalChangeCalibration()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_SetPhysicalChangeCalibration();
}
...
/*
 ...
 exam : >WSZ 8
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_SetPhysicalChangeCompensation(UINT8 mode1, UINT8 mode2)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_SetPhysicalChangeCompensation(mode1, mode2);
}
...
/*
 ...
 exam : >BAL
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_SetDetailTroubleFileByManufacture(UINT8 file_no)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_SetDetailTroubleFileByManufacture(file_no);
}
...
/*
 ...
 exam : >BAL
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_SetBasicTroubleFileByManufacture(UINT8 file_no)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_SetBasicTroubleFileByManufacture(file_no);
}
...
/*
 ...
 exam : >BAL
		...
		>
 */
API_EXPORT BOOL uvEng_MPA_SetTroubleDumpToMemory()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_SetTroubleDumpToMemory();
}
...
/*
 ...
 exam : >_EH
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_GetEdgeHandleType()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_GetEdgeHandleType();
}
...
/*
 ...
 exam : >_EHC
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_GetCCDSensorSensingDist(UINT8 type)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_GetCCDChuckSensingDist(type);
}
API_EXPORT BOOL uvEng_MPA_SetCCDSensorSensingDist(UINT16 pixel, UINT8 type)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_SetCCDChuckSensingDist(pixel, type);
}
...
/*
 ...
 exam : >_EHP
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_GetCCDPinsSensingDist(UINT8 type)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_GetCCDPinsSensingDist(type);
}
API_EXPORT BOOL uvEng_MPA_SetCCDPinsSensingDist(UINT16 pixel, UINT8 type)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_SetCCDPinsSensingDist(pixel, type);
}
...
/*
 ...
 exam : >_SFZ
		...
		>
*/
API_EXPORT BOOL uvEng_MPA_GetSafeRotateAxisZ()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_GetSafeRotateAxisZ();
}
API_EXPORT BOOL uvEng_MPA_SetSafeRotateAxisZ(DOUBLE value)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_SetSafeRotateAxisZ(value);
}
...
/*
 ...
 retn : TRUE or FALSE
*/
API_EXPORT BOOL uvCmn_MPA_IsValidSystemStatus()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return (0xffff == GetShMemMPA()->system_status);
}
...
/*
 ...
 retn : TRUE or FALSE
*/
API_EXPORT BOOL uvCmn_MPA_IsMotorArmBusy()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	/* 아직 상태가 결정된 것이 없는 경우인지 ... */
	if (0xffff == GetShMemMPA()->system_status)	return 0x00;
	
	return 0x0100 == (GetShMemMPA()->system_status & 0x0100) ? TRUE : FALSE;
}
...
/*
 ...
 retn : TRUE or FALSE
*/
API_EXPORT BOOL uvCmn_MPA_IsMotorArmIdle()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	/* 아직 상태가 결정된 것이 없는 경우인지 ... */
	if (0xffff == GetShMemMPA()->system_status)	return 0x00;

	return 0x0000 == (GetShMemMPA()->system_status & 0x0100) ? FALSE : TRUE;
}
...
/*
 ...
 retn : TRUE or FALSE
*/
API_EXPORT BOOL uvCmn_MPA_IsLastSendAckRecv()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_IsLastSendAckRecv();
}
...
/*
 ...
 retn : TRUE or FALSE
*/
API_EXPORT BOOL uvCmn_MPA_IsLastSendAckSucc()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_IsLastSendAckSucc();
}
...
/*
 ...
 retn : TRUE or FALSE
*/
API_EXPORT BOOL uvCmn_MPA_GetSystemStatusMesg(TCHAR *mesg, UINT32 size)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_GetSystemStatusMesg(mesg, size);
}
...
/*
 ...
 retn : TRUE or FALSE
*/
API_EXPORT BOOL uvCmn_MPA_GetPreviousError(TCHAR *mesg, UINT32 size)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_GetPreviousError(mesg, size);
}
...
/*
 ...
 retn : TRUE or FALSE
*/
API_EXPORT BOOL uvCmn_MPA_IsRecvCmdData(ENG_PSCC cmd)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_IsRecvCmdData(cmd);
}
API_EXPORT BOOL uvCmn_MPA_IsRecvCmdLast()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_IsRecvCmdLast();
}
API_EXPORT BOOL uvCmn_MPA_GetRecvCmdLast(PTCHAR r_cmd, UINT32 size)
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
	return uvMPA_GetRecvCmdLast(r_cmd, size);
}
...
/*
 ...
 retn : TRUE or FALSE
*/
API_EXPORT BOOL uvCmn_MPA_IsSystemError()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return FALSE;
...
/*
 ...
 retn : TRUE or FALSE
*/
API_EXPORT UINT8 uvCmn_MPA_IsWaitMotionDoneReply()
{
	BOOL bError			= FALSE;
	LPG_MPDV pstShMem	= GetShMemMPA();
...
API_EXPORT PTCHAR uvCmn_MPA_GetValueLastString()
{
	if (!IsUseLib(ENG_EDIC::en_lspa))	return NULL;
	CUniToChar csCnv;
	return csCnv.Ansi2Uni(GetShMemMPA()->last_string_data);
}
/* Currently set wafer type (Cmd : _wt) */
API_EXPORT INT8 uvCmn_MPA_GetValueWaferType()						{	return GetShMemMPA()->wafer_type;	}
/* Currently assigned parameter set to the current wafer size (unit: inch) (Cmd : _wszautoset) */
API_EXPORT INT8 uvCmn_MPA_GetValueWaferSizeInch()					{	return GetShMemMPA()->wafer_size_inch;	}
/* Currently set information mode (Cmd : inf) */
API_EXPORT UINT8 uvCmn_MPA_GetValueInfoMode()						{	return GetShMemMPA()->info_mode;	}
/* Information about whether and object is covering any of the CCD sensors (Cmd : doc) */
API_EXPORT UINT8 uvCmn_MPA_GetValueWaferLoaded()					{	return GetShMemMPA()->wafer_loaded;	}
/* Currently set mode (0 or 1 – Automatic wafer size detection mode) (Cmd : asz) */
API_EXPORT UINT8 uvCmn_MPA_GetValueWaferSizeDetection()				{	return GetShMemMPA()->wafer_size_detection;	}
/* Currently set mode (0 or 1 – “Auto scan again” mode) (Cmd : _autoscanagain) */
API_EXPORT UINT8 uvCmn_MPA_GetValueWaferScanAgain()					{	return GetShMemMPA()->wafer_scan_again;	}
/* Currently set T-axis fast speed (0 or 1– State of chuck vacuum OFF or ON after BAL) (Cmd : _finalvacc) */
API_EXPORT UINT8 uvCmn_MPA_GetValueVacuumStateAfterAlign()			{	return GetShMemMPA()->vacuum_state_after_align;	}
/* Currently setting of MGLM (0 or 1) (Cmd : mglm) */
API_EXPORT UINT8 uvCmn_MPA_GetValueWaferGlassType()					{	return GetShMemMPA()->wafer_glass_type;	}
/* Currently set notch/flat depth calculation mode (0 or 1) (Cmd : _notchdepthmode) */
API_EXPORT UINT8 uvCmn_MPA_GetValueNotchDepthMode()					{	return GetShMemMPA()->notch_depth_mode;	}
/* Currently set MTP command mode (0 or 1) (Cmd : _mtpmode) */
API_EXPORT UINT8 uvCmn_MPA_GetValueModeZAfterMovePins()				{	return GetShMemMPA()->mode_z_after_move_pins;	}
/* Currently set sampling mode (0x00 to 0x03) (Cmd : _sm) */
API_EXPORT UINT8 uvCmn_MPA_GetValueRotationSampleMode()				{	return GetShMemMPA()->rotation_sample_mode;	}
/* Currently set „Stop on pins” mode (0 or 1) (Cmd : _sp) */
API_EXPORT UINT8 uvCmn_MPA_GetValueStopOnPins()						{	return GetShMemMPA()->stop_on_pins;	}
/* Currently set value (0 or 1) (Cmd : wsz2) */
API_EXPORT UINT8 uvCmn_MPA_GetValueNotchLightSource()				{	return GetShMemMPA()->notch_light_source;	}
/* Currently set mode (0 or 1 – “Auto samples dump” mode) (Cmd : _autodumps) */
API_EXPORT UINT8 uvCmn_MPA_GetValueAlignFailAutoDumps()				{	return GetShMemMPA()->align_fail_auto_dumps;	}
/* Currently set file number (0 to 9 – file number for “Auto samples dump” mode) (Cmd : _autodumpsf) */
API_EXPORT UINT8 uvCmn_MPA_GetValueAutoSamplesDumpFile()			{	return GetShMemMPA()->auto_samples_dump_file;	}
/* 1 if the prealigner is edge handling, 0 otherwise (Cmd : _eh) */
API_EXPORT UINT8 uvCmn_MPA_GetValueIsEdgeHandling()					{	return GetShMemMPA()->is_edge_handling;	}
/* Currently set current limit of all axes (1 to 251 level)  (Cmd : _cl) */
API_EXPORT PUINT8 uvCmn_MPA_GetValueCurrentLimits()					{	return GetShMemMPA()->current_limit;	}
/* Currently set axis profile type. (cmd : pro) */
API_EXPORT PUINT8 uvCmn_MPA_GetValueVelocityProfiles()				{	return GetShMemMPA()->velocity_profile;	}
/* Currently set minimum wafer size (cmd : _minwsz) */
API_EXPORT UINT8 uvCmn_MPA_GetValueWaferMinSize()					{	return GetShMemMPA()->wafer_min_size;	}
/* Currently set maximum wafer size (cmd : _maxwsz) */
API_EXPORT UINT8 uvCmn_MPA_GetValueWaferMaxSize()					{	return GetShMemMPA()->wafer_max_size;	}
/* Currently set wafer diameter (cmd : wsz) */
API_EXPORT UINT8 uvCmn_MPA_GetValueWaferWorkSize()					{	return GetShMemMPA()->wafer_work_size;	}
/* Currently set averaging mode (current sampling mode) (0, 3 or 5) (cmd : _sam) */
API_EXPORT UINT8 uvCmn_MPA_GetValueNotchAverageMode()				{	return GetShMemMPA()->notch_average_mode;	}
/* Currently set wafer loading type (0 – load wafer on pins; 1 – load wafer on chuck) (cmd : ltc) */
API_EXPORT UINT8 uvCmn_MPA_GetValueWaferLoadingType()				{	return GetShMemMPA()->wafer_loading_type;	}
/* Currently set minimum notch depth. (1 to 100) (cmd : _mindepthmain) */
API_EXPORT UINT8 uvCmn_MPA_GetValueMinimumNotchDepth()				{	return GetShMemMPA()->minimum_notch_depth;	}
/* Currently set notch find mode (0 to 3) (cmd : _notchfindmode) */
API_EXPORT UINT8 uvCmn_MPA_GetValueNotchFindMode()					{	return GetShMemMPA()->notch_find_mode;	}
/* Currently set maximum notch/flat slope (cmd : _notchmaxderval) */
API_EXPORT UINT8 uvCmn_MPA_GetValueNotchMaxDerVal()					{	return GetShMemMPA()->notch_max_der_val;	}
/* Currently set minimum notch/flat slope (cmd : _notchminderval) */
API_EXPORT UINT8 uvCmn_MPA_GetValueNotchMinDerVal()					{	return GetShMemMPA()->notch_min_der_val;	}
/* Currently set number of samples outside notch/flat (cmd : _notchnavg) */
API_EXPORT UINT8 uvCmn_MPA_GetValueNotchNumAverage()				{	return GetShMemMPA()->notch_num_average;	}
/* Currently set limit (1 -> 0.0001 inch) (cmd : _ao2) */
API_EXPORT UINT16 uvCmn_MPA_GetValueAlignOffsetTwice()				{	return GetShMemMPA()->align_offset_twice;	}
/* Currently set acceptable offset (1 -> 0.0001 inch) (cmd : _aof) */
API_EXPORT UINT16 uvCmn_MPA_GetValueAlignOffsetAccept()				{	return GetShMemMPA()->align_offset_accept;	}
/* All prealigner axes home switch state (cmd : rhs) */
API_EXPORT UINT16 uvCmn_MPA_GetValueAxisSwitchActive()				{	return GetShMemMPA()->axis_switch_active;	}
/* System status word (cmd : sta) */
API_EXPORT UINT16 uvCmn_MPA_GetValueSystemStatus()					{	return GetShMemMPA()->system_status;	}
/* Current value of CCD sensor(cmd : ccd) */
API_EXPORT UINT16 uvCmn_MPA_GetValueCCDPixels()						{	return GetShMemMPA()->ccd_pixels;	}
/* Number of notches falling within minimum/maximum depth/width criteria(cmd : ngn) */
API_EXPORT INT16 uvCmn_MPA_GetValueLastAlignSucc()					{	return GetShMemMPA()->last_align_succ;	}
/* Number of notches failing out of minimum/maximum depth/width criteria (cmd : nbn) */
API_EXPORT INT16 uvCmn_MPA_GetValueLastAlignFail()					{	return GetShMemMPA()->last_align_fail;	}
/* Description of previous error (cmd : per) */
API_EXPORT UINT16 uvCmn_MPA_GetValuePreviousCmdFail()				{	return GetShMemMPA()->previous_cmd_fail;	}
/* Currently set minimum good data samples (cmd : _mgd) */
API_EXPORT UINT16 uvCmn_MPA_GetValueMinGoodSampleCount()			{	return GetShMemMPA()->min_good_sample_count;	}
/* Currently set chuck CCD value (cmd : _ehc) */
API_EXPORT UINT16 uvCmn_MPA_GetValueCCDChuckSensingValue()			{	return GetShMemMPA()->ccd_chuck_sensing_value;	}
/* Currently set chuck CCD value of smaller size (cmd : _ehc1) */
API_EXPORT UINT16 uvCmn_MPA_GetValueCCDChuckSensingSmall()			{	return GetShMemMPA()->ccd_chuck_sensing_small;	}
/* Currently set chuck CCD value of greater size. (cmd : _ehc2) */
API_EXPORT UINT16 uvCmn_MPA_GetValueCCDChuckSensingGreat()			{	return GetShMemMPA()->ccd_chuck_sensing_great;	}
/* Currently set chuck pins CCD value (cmd : _ehp) */
API_EXPORT UINT16 uvCmn_MPA_GetValueCCDPinsSensingValue()			{	return GetShMemMPA()->ccd_pins_sensing_value;	}
/* Currently set chuck pins CCD value of smaller size. (cmd : _ehp1) */
API_EXPORT UINT16 uvCmn_MPA_GetValueCCDPinsSensingSmall()			{	return GetShMemMPA()->ccd_pins_sensing_small;	}
/* Currently set chuck pins CCD value of greater size (cmd : _ehp2) */
API_EXPORT UINT16 uvCmn_MPA_GetValueCCDPinsSensingGreat()			{	return GetShMemMPA()->ccd_pins_sensing_great;	}
/* Currently set CCD center (cmd : _sc) */
API_EXPORT UINT32 uvCmn_MPA_GetValueCCDSensorCenter()				{	return GetShMemMPA()->ccd_sensor_center;	}
/* Currently set timeout value (cmd : _to) */
API_EXPORT UINT32 uvCmn_MPA_GetValueLastParamTimeout()				{	return GetShMemMPA()->last_param_timeout;	}
/* Currently set minimum notch depth. (cmd : _mnd) */
API_EXPORT UINT32 uvCmn_MPA_GetValueNotchRangeDepthMin()			{	return GetShMemMPA()->notch_range_depth_min;	}
/* Currently set maximum notch depth. (cmd : _mxd) */
API_EXPORT UINT32 uvCmn_MPA_GetValueNotchRangeDepthMax()			{	return GetShMemMPA()->notch_range_depth_max;	}
/* Currently set minimum notch width. (cmd : _mnw) */
API_EXPORT UINT32 uvCmn_MPA_GetValueNotchRangeWidthMin()			{	return GetShMemMPA()->notch_range_width_min;	}
/* Currently set maximum notch width (cmd : _mxw) */
API_EXPORT UINT32 uvCmn_MPA_GetValueNotchRangeWidthMax()			{	return GetShMemMPA()->notch_range_width_max;	}
/* Currently set minimum CCD value for square substrates (cmd : _sqmin) */
API_EXPORT UINT32 uvCmn_MPA_GetValueCCDGrabSizeMin()				{	return GetShMemMPA()->ccd_grab_size_min;	}
/* Currently set maximum CCD value for square substrates (cmd : _sqmax) */
API_EXPORT UINT32 uvCmn_MPA_GetValueCCDGrabSizeMax()				{	return GetShMemMPA()->ccd_grab_size_max;	}
/* Two numbers, denoting depth and width of requested (or first) notch (cmd : ndw) */
API_EXPORT PUINT32 uvCmn_MPA_GetValueFindDepthWidth()				{	return GetShMemMPA()->find_depth_width;	}
/* Currently set position error limit of all axes (cmd : _el) */
API_EXPORT PUINT16 uvCmn_MPA_GetValueErrorLimit()					{	return GetShMemMPA()->error_limit;	}
/* Currently set final wafer orientation angle (cmd : fwo) (unit : um or degree or sec) */
API_EXPORT DOUBLE uvCmn_MPA_GetValueRotateAfterAlign()				{	return GetShMemMPA()->rotate_after_align;	}
/* Currently set transfer down position (cmd : _td) (unit : um or degree or sec) */
API_EXPORT DOUBLE uvCmn_MPA_GetValueWaferTransSafePosUp()			{	return GetShMemMPA()->wafer_trans_safe_pos_up;	}
/* Currently set transfer up position (cmd : _tu) (unit : um or degree or sec) */
API_EXPORT DOUBLE uvCmn_MPA_GetValueWaferTransSafePosDown()			{	return GetShMemMPA()->wafer_trans_safe_pos_down;	}
/* Currently set safe Z position (cmd : _sfz) (unit : um or degree or sec) */
API_EXPORT DOUBLE uvCmn_MPA_GetValueSafeRotateZPos()				{	return GetShMemMPA()->safe_rotate_z_pos;	}
/* Currently set angle (cmd : _sa) (unit : um or degree or sec) */
API_EXPORT DOUBLE uvCmn_MPA_GetValueCCDRAxisAngle()					{	return GetShMemMPA()->ccd_r_axis_angle;	}
/* Currently set pins position offset (Moving Up) (cmd : _ppcu) (unit : um or degree or sec) */
API_EXPORT DOUBLE uvCmn_MPA_GetValueOffsetChuckPinPosUp()			{	return GetShMemMPA()->offset_chuck_pin_pos_up;	}
/* Currently set pins position offset (Moving Down) (cmd : _ppcd) (unit : um or degree or sec) */
API_EXPORT DOUBLE uvCmn_MPA_GetValueOffsetChuckPinPosDown()			{	return GetShMemMPA()->offset_chuck_pin_pos_down;	}
/* Currently set pins position (cmd : _pp) (unit : um or degree or sec) */
API_EXPORT DOUBLE uvCmn_MPA_GetValueLevelChuckPinsPosZ()			{	return GetShMemMPA()->level_chuck_pins_pos_z;	}
/* Currently set load up position for all axes. (cmd : _lu) (unit : um or degree or sec) */
API_EXPORT PDOUBLE uvCmn_MPA_GetValueWaferLoadingUpPos()			{	return GetShMemMPA()->wafer_loading_up_pos;	}
/* Currently set load down position for all axes. (cmd : _ld) (unit : um or degree or sec) */
API_EXPORT PDOUBLE uvCmn_MPA_GetValueWaferLoadingDownPos()			{	return GetShMemMPA()->wafer_loading_down_pos;	}
/* Current position of all axes (cmd : mcpo) (unit : um or degree or sec) */
API_EXPORT PDOUBLE uvCmn_MPA_GetValueAxisPos()						{	return GetShMemMPA()->axis_pos;	}
/* Currently set customized home position of all the axes (cmd : ) (unit : um or degree or sec) */
API_EXPORT PDOUBLE uvCmn_MPA_GetValueHomePos()						{	return GetShMemMPA()->homed_pos;	}
/* Currently set home offset of all the axes (cmd : _ho) (unit : um or degree or sec) */
API_EXPORT PDOUBLE uvCmn_MPA_GetValueHomeOffset()					{	return GetShMemMPA()->home_offset;	}
/* Currently set forward direction software limit for all axes. (cmd : _fl) (unit : um or degree or sec) */
API_EXPORT PDOUBLE uvCmn_MPA_GetValueDirectLimitF()					{	return GetShMemMPA()->direct_f_limit;	}
/* Currently set Reverse direction software limit for all the axes (cmd : _rl) (unit : um or degree or sec) */
API_EXPORT PDOUBLE uvCmn_MPA_GetValueDirectLimitR()					{	return GetShMemMPA()->direct_r_limit;	}
/* Currently set axis acceleration (cmd : acl) (unit : um or degree or sec) */
API_EXPORT PDOUBLE uvCmn_MPA_GetValueAxisACL()						{	return GetShMemMPA()->axis_acl;	}
/* Currently set axis deceleration (cmd : dcl) (unit : um or degree or sec) */
API_EXPORT PDOUBLE uvCmn_MPA_GetValueAxisDCL()						{	return GetShMemMPA()->axis_dcl;	}
/* Currently set axis acceleration jerk (cmd : ajk) (unit : um or degree or sec) */
API_EXPORT PDOUBLE uvCmn_MPA_GetValueAxisAJK()						{	return GetShMemMPA()->axis_ajk;	}
/* Currently set axis deceleration jerk (cmd : djk) (unit : um or degree or sec) */
API_EXPORT PDOUBLE uvCmn_MPA_GetValueAxisDJK()						{	return GetShMemMPA()->axis_djk;	}
/* Currently set speed for all or one axis (cmd : spd) (unit : um or degree or sec) */
API_EXPORT PDOUBLE uvCmn_MPA_GetValueAxisSpeed()					{	return GetShMemMPA()->axis_speed;	}
/* Displacement (offset), offset angle, and notch/flat angle (cmd : mrwi) */
API_EXPORT PDOUBLE uvCmn_MPA_GetValueRWIWaferInfo()					{	return GetShMemMPA()->rwi_wafer_info;	}
/* Currently set measure acceleration (cmd : _ma) (unit : um or degree or sec) */
API_EXPORT PDOUBLE uvCmn_MPA_GetValueMeasureACL()					{	return GetShMemMPA()->measure_acceleration;	}
/* Currently set measure deceleration (cmd : _md) (unit : um or degree or sec) */
API_EXPORT PDOUBLE uvCmn_MPA_GetValueMeasureDCL()					{	return GetShMemMPA()->measure_deceleration;	}
/* Currently set measuring speed (cmd : _ms) (unit : um or degree or sec) */
API_EXPORT PDOUBLE uvCmn_MPA_GetValueMeasureSpeed()					{	return GetShMemMPA()->measure_speed;	}
