...
*/
API_IMPORT DOUBLE uvEng_PM100D_GetCurPower();
/*
 ...
 retn : TRUE or FALSE
*/
API_IMPORT BOOL uvEng_PM100D_SetQueryWaveLength(INT16 wave);
/*
 desc : Get Wave Length
 parm : None
 retn : 양수 값 (음수 값인 경우 실패) (365, 385, 390, 405 (nm))
*/
API_IMPORT INT16 uvEng_PM100D_GetQueryWaveLength();
