...
extern "C"
{
	...
	API_IMPORT BOOL uEng_Philhmi_Send_P2C_LIGHT_ALARM_STATUS(STG_PP_P2C_LIGHT_ALARM_NOTIFY& stSend, STG_PP_P2C_LIGHT_ALARM_NOTIFY_ACK& stRecv, int nTimeout = 5000);
	...
	API_IMPORT BOOL uvEng_Philhmi_Send_C2P_ALARM_STATUS_ACK(STG_PP_C2P_ALARM_STATUS_ACK& stSend);
	...
	API_IMPORT BOOL uvEng_Philhmi_Send_Log_Alarm_PhilSend(unsigned char Ecode);
