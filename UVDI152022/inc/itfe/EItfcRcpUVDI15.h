...
/*                                           Job Recipe                                          */
/* --------------------------------------------------------------------------------------------- */
API_IMPORT VOID uvEng_JobRecipe_ZeroSelectRecipe();
/*
 desc : 등록된 Job 레시피 개수 반환
 parm : None
 retn : 등록된 개수 반환
*/
API_IMPORT UINT32 uvEng_JobRecipe_GetCount();
/*
...
/*
 ...
 retn : TRUE or FALSE
*/
API_IMPORT BOOL uvEng_JobRecipe_SaveFile();
/*
...
*/
API_IMPORT BOOL uvEng_JobRecipe_RecipeAppend(LPG_RJAF recipe);
/*
 desc : Job Recipe 기본 정보 수정
 parm : recipe	- [in]  Recipe 기본 정보가 저장된 구조체 포인터
 retn : TRUE or FALSE
*/
API_IMPORT BOOL uvEng_JobRecipe_RecipeModify(LPG_RJAF recipe);
/*
 desc : Job Recipe 기본 삭제
 parm : recipe	- [in]  제거하려는 레시피의 기본 이름
 retn : TRUE or FALSE
*/
API_IMPORT BOOL uvEng_JobRecipe_RecipeDelete(PTCHAR recipe);

API_IMPORT int uvEng_JobRecipe_GetSelectRecipeIndex();
...
/*
 ...
 retn : TRUE or FALSE
*/
API_IMPORT BOOL uvEng_ExpoRecipe_ReloadFile();
...
/*
 ...
 retn : TRUE (Finded) or FALSE (Not find)
*/
API_IMPORT BOOL uvEng_ExpoRecipe_RecipeFind(PTCHAR recipe);
/*
 desc : Expo 레시피 이름을 통한 레시피 기본 정보 반환
 parm : recipe	- [in]  검색하고자 하는 레시피 이름
 retn : 반환될 레시피가 저장된 구조체 포인터
*/
API_IMPORT LPG_REAF uvEng_ExpoRecipe_GetRecipeOnlyName(PTCHAR recipe);
/*
 desc : Expo 레시피 기본 정보가 저장된 인덱스 위치에 있는 레시피 반환
 parm : index	- [in]  가져오고자 하는 레시피 인덱스 (Zero-based)
 retn : 반환될 레시피가 저장된 구조체 포인터
*/
API_IMPORT LPG_REAF uvEng_ExpoRecipe_GetRecipeIndex(INT32 index);
/*
...
/*
 ...
 retn : TRUE or FALSE
*/
API_IMPORT BOOL uvEng_ExpoRecipe_SaveFile();
/*
 ...
 retn : TRUE or FALSE (개수 초과. 최대 15개)
*/
API_IMPORT BOOL uvEng_ExpoRecipe_RecipeAppend(LPG_REAF recipe);
/*
 desc : Expo Recipe 기본 정보 수정
 parm : recipe	- [in]  Recipe 기본 정보가 저장된 구조체 포인터
 retn : TRUE or FALSE
*/
API_IMPORT BOOL uvEng_ExpoRecipe_RecipeModify(LPG_REAF recipe);
/*
 desc : Expo Recipe 기본 삭제
 parm : recipe	- [in]  제거하려는 레시피의 기본 이름
 retn : TRUE or FALSE
*/
API_IMPORT BOOL uvEng_ExpoRecipe_RecipeDelete(PTCHAR recipe);

API_IMPORT int uvEng_ExpoRecipe_GetSelectRecipeIndex();
