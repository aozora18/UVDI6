...
/*
 ...
 retn : TRUE or FALSE
*/
API_IMPORT BOOL uvEng_Trig_ReqTriggerStrobe(BOOL enable);
/*
 desc : 내부 트리거 설정
 parm : cam_id	- [in]  Align Camera Index (1 or 2)
 retn : TRUE or FALSE
*/
API_IMPORT BOOL uvEng_Trig_ReqEncoderLive(UINT8 cam_id);
/*
 desc : 내부 트리거 설정 초기화
 parm : None
 retn : TRUE or FALSE
*/
API_IMPORT BOOL uvEng_Trig_ReqEncoderOutReset();
/*
 desc : 트리거 1개 발생 시킴 (Only Trigger Event)
 parm : ch_no	- [in]  채널 번호 (1 or 2)
 retn : TRUE or FALSE
*/
API_IMPORT BOOL uvEng_Trig_ReqTrigOutOneOnly(UINT8 ch_no);
/*
 ...
 retn : TRUE or FALSE
*/
API_IMPORT BOOL uvEng_Trig_ReqTrigOutOne(UINT8 ch_no, BOOL enable=TRUE);
#if 1
/*
 ...
 retn : TRUE or FALSE
*/
API_IMPORT BOOL uvEng_Trig_ReqInitUpdate();
#endif
/*
 ...
 retn : TRUE or FALSE
*/
API_IMPORT BOOL uvEng_Trig_ResetTrigPosAll();
/*
 ...
 retn : TRUE or FALSE
*/
API_IMPORT BOOL uvEng_Trig_IsTrigPosReset(UINT8 cam_id, UINT8 count=MAX_REGIST_TRIG_POS_COUNT);
/*
...
*/
API_IMPORT BOOL uvEng_Trig_IsSendCmdCountUnder(UINT16 count);
/*
 ...
 retn : TRUE or FALSE
*/
API_IMPORT BOOL uvEng_Trig_ReqWriteAreaTrigPos(BOOL direct,
...
/*
 ...
 retn : TRUE or FALSE
*/
API_IMPORT BOOL uvEng_Trig_ReqWriteAreaTrigPosCh(UINT8 cam_id, UINT8 start, UINT8 count, PUINT32 pos,
												 ENG_TEED enable, BOOL clear);
/*
 ...
 retn : TRUE or FALSE
*/
API_IMPORT BOOL uvEng_Trig_IsTrigPosEqual(UINT8 cam_id, UINT8 index, UINT32 pos);
...
/*
 ...
 retn : TRUE or FALSE
*/
API_IMPORT BOOL uvCmn_Trig_IsConnected();
/*
 desc : Trigger 내의 Strobe이 Enable or Disable 상태 값 반환
 parm : None
 retn : TRUE or FALSE
*/
API_IMPORT BOOL uvCmn_Trig_IsStrobEnable();
/*
 desc : Trigger 내의 Strobe이 Enable or Disable 상태 값 반환
 parm : None
 retn : TRUE or FALSE
*/
API_IMPORT BOOL uvCmn_Trig_IsStrobDisable();
