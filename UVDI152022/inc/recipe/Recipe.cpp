...
#include "pch.h"
#include "Recipe.h"		/* Gerber Recipe */
...
/*
 ...
 retn : None
*/
CRecipe::CRecipe(PTCHAR work_dir, CLedPower *led_power, LPG_LDSM mem_luria)
	: CBase(work_dir)
{
...
/*
 ...
 retn : None
*/
VOID CRecipe::ResetSelectRecipe()
{
	m_pstRecipe	= NULL;
}
...
*/
LPG_RBGF CRecipe::GetSelectRecipe()
{
	return m_pstRecipe;
}
...
/*
 ...
 retn : TRUE or FALSE
*/
BOOL CRecipe::ParseRecipe(PCHAR data, UINT32 size)
{
	UINT8 u8Div			= 36;
	...
	for (i=0x00; i<0x0e; i++)
	{
		...
		case 0x06 : case 0x07 : case 0x08 : case 0x09 : case 0x0a : case 0x0c : case 0x0d : 
			...
			case 0x06 : pstRecipe->mark_scale_range	= (DOUBLE)atof(szValue);	break;
...
BOOL CRecipe::SaveFile()
{
	...
	fputs("; recipe_name,gerber_path,gerber_name,led_power_name,lot_date,text_string,serial_decode,"
		  ...
		  "mark_model,align_method,mark_count,area_size_w,h\n", fp);
...
/*
 ...
 retn : TRUE or FALSE
*/
BOOL CRecipe::CalcSpeedEnergy(LPG_RBGF recipe)
{
	UINT8 i, j;
...
*/
BOOL CRecipe::RecipeFind(PCHAR recipe)
{
	POSITION pPos	= NULL;
...
*/
BOOL CRecipe::RemoveRecipe(PCHAR recipe)
{
...
*/
LPG_RBGF CRecipe::GetRecipeOnlyName(PCHAR recipe)
{
	POSITION pPos	= NULL;
	LPG_RBGF pstData= NULL;
...
/*
 ...
 retn : 반환될 레시피가 저장된 구조체 포인터
*/
LPG_RBGF CRecipe::GetRecipePathName(PCHAR name)
{
...
/*
 ...
 retn : 반환될 레시피가 저장된 구조체 포인터
*/
LPG_RBGF CRecipe::GetRecipeIndex(INT32 index)
{
	POSITION pPos	= NULL;
...
*/
BOOL CRecipe::SelRecipeOnlyName(PCHAR recipe)
{
	BOOL bSucc			= FALSE;
	POSITION pPos		= NULL;
	LPG_RBGF pstRecipe	= NULL;
...
/*
 ...
 retn : TRUE (선택 성공) or FALSE (선택 실패)
*/
BOOL CRecipe::SelRecipePathName(PCHAR recipe)
{
	CHAR szGerberPath[MAX_GERBER_NAME];
	BOOL bSucc			= FALSE;
	POSITION pPos		= NULL;
...
/*
 ...
 retn : TRUE or FALSE
*/
BOOL CRecipe::CopyRecipe(LPG_RBGF source, LPG_RBGF target)
{
	UINT8 i	= 0x00, j = 0;
...
*/
BOOL CRecipe::RecipeAppend(LPG_RBGF recipe)
{
	BOOL bSucc			= FALSE;
	LPG_RBGF pstRecipe	= NULL;
...
/*
 ...
 retn : TRUE or FALSE
*/
BOOL CRecipe::RecipeModify(LPG_RBGF recipe)
{
	LPG_RBGF pstRecipe	= NULL;
...
/*
 ...
 retn : TRUE or FALSE
*/
BOOL CRecipe::RecipeDelete(PCHAR recipe)
{
	/* 기존에 등록된 레시피가 있는지 확인 */
...
/*
 ...
 retn : TRUE or FALSE
*/
BOOL CRecipe::IsRecipeSharedType()
{
...
/*
 ...
 retn : 개수 반환
*/
UINT8 CRecipe::GetSelectRecipeLocalMarkCount()
{
...
/*
 ...
 retn : TRUE or FALSE
*/
BOOL CRecipe::GetLocalMarkToGrabNum(UINT8 mark, UINT8 &cam_id, UINT8 &img_id)
{
...
*/
UINT8 CRecipe::GetLocalMarkToScanNum(UINT8 mark_id)
{
	UINT8 u8Mark	= 0;
...
/*
 ...
 retn : TRUE or FALSE
*/
BOOL CRecipe::GetGrabNumToLocalMark(UINT8 cam_id, UINT8 img_id, UINT8 &mark)
{
	UINT8 u8Count	= GetSelectRecipeLocalMarkCount();
...
*/
BOOL CRecipe::GetImageToStageDirect(UINT8 img_id)
{
...
*/
UINT8 CRecipe::GetScanLocalMarkCount()
{
	switch (m_pstRecipe->align_type)
	{
	/* Normal Type */
