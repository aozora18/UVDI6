...
public:
	...
	int Send_P2C_LIGHT_ALARM_NOTIFY(STG_PP_P2C_LIGHT_ALARM_NOTIFY& stSend, STG_PP_P2C_LIGHT_ALARM_NOTIFY_ACK& stRecv, int nTimeout = 10000);
	...
	int Send_C2P_ALARM_STATUS_ACK(STG_PP_C2P_ALARM_STATUS_ACK& stSend, int nTimeout = 10000);
