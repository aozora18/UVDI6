...
public:
	...
	static void __cdecl				WheatyPureCallHandler();
	static void __cdecl				WheatySignal(int signal);
	static unsigned int __stdcall	ThreadMiniDump(void *lpParam);
	static void printTracesForAllThreads(bool);

	static long m_ExceptionCount;
private:
	...
	static _purecall_handler m_previousPureCallHandler;
