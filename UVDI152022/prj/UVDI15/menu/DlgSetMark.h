...
class CDlgSetMark : public CDialogEx
{
	DECLARE_DYNAMIC(CDlgSetMark)

public:
	CDlgSetMark(CWnd* pParent = nullptr);   // 표준 생성자입니다.
	virtual ~CDlgSetMark();

// 대화 상자 데이터입니다.
#ifdef AFX_DESIGN_TIME
	enum { IDD = IDD_SETMARK };
#endif
...
public:
	...
	afx_msg void OnBnClickedBtnMarkExit();
	VOID InitDisp();
	...
	INT DlgPutSetMarkDisp(DOUBLE fi_Rate);
	...
	afx_msg void OnBnClickedBtnMaskClear();
