...
/*
 ...
 retn : None
*/
CDlgSubTab::CDlgSubTab(UINT32 id, CWnd* parent)
	: CMyDialog(id, parent)
{
	m_bDrawBG		= TRUE;
	m_bTooltip		= TRUE;
	...
	/* 멤버 변수 초기화 */
	m_enDlgID		= ENG_CMDI_TAB::en_menu_tab_none;
}

CDlgSubTab::~CDlgSubTab()
{
}

BEGIN_MESSAGE_MAP(CDlgSubTab, CMyDialog)
END_MESSAGE_MAP()
...
*/
BOOL CDlgSubTab::Create(HWND h_view)
{
