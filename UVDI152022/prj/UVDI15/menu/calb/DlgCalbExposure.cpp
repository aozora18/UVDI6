...
#include "./exposure/DlgCalbExposureFEM.h"
#include "./exposure/DlgCalbExposureFlush.h"
...
/*
 ...
 retn : None
*/
CDlgCalbExposure::CDlgCalbExposure(UINT32 id, CWnd* parent)
	: CDlgSubMenu(id, parent)
{
	m_enDlgID = ENG_CMDI_SUB::en_menu_sub_calb_exposure;
	m_enTabDlgID = ENG_CMDI_TAB::en_menu_tab_none;
	m_pDlgMenu = NULL;
}

CDlgCalbExposure::~CDlgCalbExposure()
{
}
...
/*
 ...
 retn : None
*/
VOID CDlgCalbExposure::DoDataExchange(CDataExchange* dx)
{
	...
	for (i = 0; i < eCALB_EXPOSURE_PIC_MAX; i++)		DDX_Control(dx, u32StartID + i, m_pic_ctl[i]);
}
...
*/
BOOL CDlgCalbExposure::PreTranslateMessage(MSG* msg)
{
...
/*
 ...
 retn : TRUE or FALSE
*/
BOOL CDlgCalbExposure::OnInitDlg()
{
	/* 컨트롤 초기화 */
	InitCtrl();

	if (!CreateMenu(IDC_CALB_EXPOSURE_BTN_SUBMENU_FEM))	return FALSE;

	SetTimer(eCALB_EXPOSURE_TIMER_START, 200, NULL);
...
/*
 ...
 retn : None
*/
VOID CDlgCalbExposure::OnExitDlg()
{
	KillTimer(eCALB_EXPOSURE_TIMER_START);
	DeleteMenu();
}
...
/*
 ...
 retn : None
*/
VOID CDlgCalbExposure::OnPaintDlg(CDC* dc)
{
...
/*
 ...
 retn : None
*/
VOID CDlgCalbExposure::OnResizeDlg()
{
}
...
/*
 ...
 retn : None
*/
VOID CDlgCalbExposure::UpdatePeriod(UINT64 tick, BOOL is_busy)
{
...
/*
 ...
 retn : None
*/
VOID CDlgCalbExposure::UpdateControl(UINT64 tick, BOOL is_busy)
{
	UINT8 i = 0x00;
...
/*
 ...
 retn : None
*/
VOID CDlgCalbExposure::InitCtrl()
{
...
/*
 ...
 retn : TRUE or FALSE
*/
BOOL CDlgCalbExposure::InitObject()
{
...
/*
 ...
 retn : None
*/
VOID CDlgCalbExposure::CloseObject()
{
}
...
/*
 ...
 retn : None
*/
VOID CDlgCalbExposure::OnBtnClick(UINT32 id)
{
	CreateMenu(id);
}
...
/*
 ...
 retn : None
*/
VOID CDlgCalbExposure::DeleteMenu()
{
...
/*
 ...
 retn : TRUE or FALSE
*/
BOOL CDlgCalbExposure::CreateMenu(UINT32 id)
{
	UINT32 u32DlgID = 0;
	...
	u32DlgID = IDD_CALB_EXPOSURE_FEM + (id - IDC_CALB_EXPOSURE_BTN_SUBMENU_FEM);
	/* 해당 자식 (메뉴) 윈도 메모리 할당 */
	switch (id)
	{
	...
	/* 자식 (메뉴) 윈도 생성 */
	if (!m_pDlgMenu->Create(m_pic_ctl[eCALB_EXPOSURE_PIC_MENU].GetSafeHwnd()))
	{
		delete m_pDlgMenu;
		m_pDlgMenu = NULL;
		return FALSE;
...
void CDlgCalbExposure::OnTimer(UINT_PTR nIDEvent)
{
	if (eCALB_EXPOSURE_TIMER_START == nIDEvent)
	{
