...
// 			for (auto& mapping : io.vMappingInterLockIO)
// 			{
// 				for (auto& check_mapping : m_vIO[eType])
// 				{
// 					if (mapping.nIndex == check_mapping.nIndex)
// 					{
// 						if (mapping.bReverse)
// 						{
// 							// send philhmi
// 							stOutput.usIndex = mapping.nIndex;
// 							stOutput.usSignal = false;
// 
// 							TRACE(_T("MAPPINGIO Index : %s - ONOFF : %d\n"), m_vIO[eType].at(mapping.nIndex).strName.c_str(), stOutput.usSignal);
// 							if (uvEng_Philhmi_Send_P2C_OUTPUT_ONOFF(stOutput, stOutputAck))
// 							{
// 								if (0 == stOutputAck.usErrorCode)
// 								{
// 									check_mapping.bOn = false;
// 								}
// 							}
// 						}
// 						else
...
// 							// send philhmi
// 							stOutput.usIndex = mapping.nIndex;
// 							stOutput.usSignal = true;
// 							TRACE(_T("MAPPINGIO Index : %s - ONOFF : %d\n"), m_vIO[eType].at(mapping.nIndex).strName.c_str(), stOutput.usSignal);
// 							if (uvEng_Philhmi_Send_P2C_OUTPUT_ONOFF(stOutput, stOutputAck))
// 							{
// 								if (0 == stOutputAck.usErrorCode)
// 								{
// 									check_mapping.bOn = true;
// 								}
// 							}
// 						}
// 
...
// 			}
// 
// 			for (auto& mapping : io.vMappingOutput)
// 			{
// 				for (auto& check_mapping : m_vIO[eType])
// 				{
// 					if (mapping.nIndex == check_mapping.nIndex)
